					      ...
					      <tr>
					        ...
					        <td>
                              ...
                              <button type="button" class="btn-xs btn-primary" onClick="location.href='acomodacion.php?id=<?php echo $fi['id'];?>'">ACOMODACIÓN</button>
                                <button type="button" class="btn-xs btn-primary" onClick="location.href='roominglist.php?id=<?php echo $fi['id'];?>'">ROOMING LIST</button>
								   <button type="button" class="btn-xs btn-primary" onClick="location.href='roominglist3.php?id=<?php echo $fi['id'];?>'">LIQUIDACION</button>
