...
?>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">	
		...
		$total_programa_tarifabase=$datPrograma['valor_aereo']+$datPrograma['valor_terrestre'];
...
//$fecha_OUTOK->modify("-1 day");						  
    ...
    echo '<th>'.$date->format("Y-m-d") . "</th>";
					       ...
					       <?php 
							...
							$resultado=$control->roomingListGrupo($_REQUEST['id']);
 ...
 $grupo=explode(";",$fis['viajeros']);
					...
					$grupo=explode(";",$fis['viajeros']);
							...
							// var_dump($datviajero2);
							if($datviajero2['estado']!="VIAJA"){
							echo "<br/><span style='color:red'>".$datviajero2['estado']."</span>";
							}
								echo "</td>";
								?>
								  <td style="border-top: solid 2px #000000; border-left: solid 1px;
   								 border-right: solid 1px; border-bottom: dashed 1px #000000;border-bottom: dashed 1px #000000;"><?php
								
								
								$obsd=$control->verObservaciones($viajero2);
								$ob="";
							while ($fit = mysql_fetch_array($obsd, MYSQL_ASSOC)) {
								
							$ob="(".$fit['fecha_registro'].") ".$fit['comentario'];
							 } 
								
								echo $ob;?></td>
								<?php echo "<td style='border-top: solid 2px #000000; border-left: solid 1px;
   								 border-right: solid 1px;border-bottom: dashed 1px #000000;'>".$datviajero2['otro']."</td>";
								?>
								  	
								  	<td style="border-top: solid 2px #000000; border-left: solid 1px;
   								 border-right: solid 1px; border-bottom: dashed 1px #000000;border-bottom: dashed 1px #000000;"><?php if($datviajero2['record']!=''){
							  ...
							  ?>
								...
								$totalViaje=0;
								$valortk2= $control->valorViajeroTK($datviajero2['otro'],$datPrograma);					
								$valorMtk2= $control->consultarModificaciones($datviajero2['id'],$datPrograma['id'],'TK');
								$totalTK2=($valortk2+$valorMtk2);
					   			
								$valorpt2= $control->valorViajeroPT($datviajero2['otro'],$datPrograma); 
								$valorMpt2= $control->consultarModificaciones($datviajero2['id'],$datPrograma['id'],'PT'); 
						 ...
						 // echo $valorpt['viajeros']."-";
								...
								//$pag=$pagoTotal;
									foreach($pagos as $pay) {
                                        ...
                                        $pay = round( $pay*$price_adjustment,0);
										
										
								  ?>
								
								<td valign="middle" align="center" style="border-top: solid 2px #000000; border-left: solid 1px;
   								 border-right: solid 1px; border-bottom: dashed 1px #000000;">
									<?php 
									//var_dump($datviajero2);
										// var_dump($cnt);
								...
								<?php }?>
								<td style="border-top: solid 2px #000000; border-left: solid 1px;
   								 border-right: solid 1px;border-bottom: dashed 1px #000000;" align="center"><?php 
	...
	echo '</td>';
		...
		$sup_total=$sup_total+$totalhab;													    echo "$".$totalhab;
					        ...
					        <tr>
					          ...
					          <td style="border-bottom: dashed 1px #000000;"><?php 
				...
				$datviajero=$control->datosViajeroID($grupo[$i]);
							 ...
							 echo $datviajero['nombres']." ".$datviajero['apellidos']."";
							  echo "</td>";
								...
								$obsd=$control->verObservaciones($datviajero['id']);
								$ob="";
							while ($fit = mysql_fetch_array($obsd, MYSQL_ASSOC)) {
							...
							$ob="(".$fit['fecha_registro'].") ".$fit['comentario'];
								...
								echo $ob;?></td>
									<?php echo "<td style=' border-left: solid 1px;
   								 border-right: solid 1px;border-bottom: dashed 1px #000000;'>".$datviajero['otro']."</td>";
							  ?>
								  		
								  
								  	<td style="border-left: solid 1px;
   								 border-right: solid 1px; border-bottom: dashed 1px #000000;"><?php if($datviajero['record']!=''){
																  $rec=$control->datosContratoRecord($datviajero['record']);
																  echo $rec['nombre'];
						 ...
						 // echo $valorpt['viajeros']."-";
					       ...
					       <td style="border-top: dashed 1px #000000; border-left: solid 1px;
   								 border-right: solid 1px;" align="center"><?php echo $tt+".";
							   //CALCULO DE VALOR DEL PROGRAMA PARA ESTE VIAJERO
								$totalViaje=0;
								$valortk2= $control->valorViajeroTK($datviajero['otro'],$datPrograma);					
								$valorMtk2= $control->consultarModificaciones($datviajero['id'],$datPrograma['id'],'TK');
								$totalTK2=($valortk2+$valorMtk2);
					   			
								$valorpt2= $control->valorViajeroPT($datviajero['otro'],$datPrograma); 
								$valorMpt2= $control->consultarModificaciones($datviajero['id'],$datPrograma['id'],'PT'); 
					  			$totalPT2=($valorpt2+$valorMpt2);
								$totalViaje=$totalPT2+$totalTK2;
								//FIN VALOR PROGRAMA
							   ...
							   ?></td>
									<td style="border-top: dashed 1px #000000; border-left: solid 1px;
   								 border-right: solid 1px; " align="center"><?php echo $totalViaje;?></td>
									<td style="border-top: dashed 1px #000000; border-left: solid 1px;
   								 border-right: solid 1px;" align="center"><?php echo $totalViaje-$tt;?></td>
								
					          </tr>
                              <?php  } ?>
					        <?php } ?>
                            <tr>
								<td colspan="314"><p>GRAN TOTAL: $<?php echo $sup_total;?></p></td>
