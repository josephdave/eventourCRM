      ...
      <div class="module-body">
        <!--     
				...
				<div class="panel panel-default">
					<div class="panel-heading">LIQUIDACION POR VIAJERO <a href="liquidacion_viajero.php?grupo=<?php echo $prospecto['id'];?>">(VER DETALLADO)</a></div>
	...
	white-space: nowrap;height: 500px;" class="table-area">
					    ...
					    <thead>
					      <tr >
                           ...
                           <?php 
						    ...
						    <th>&nbsp;</th>
							  <th bgcolor="#C2F1A6">Costo Total<br></th>
                           
                           <!-- <th>Pagos Viajero PT</th>-->
                            <!-- <th bgcolor="#C2F1A6">Valor Programa TK</th>-->
                            <th bgcolor="#C2F1A6">Valor Programa PT</th>
                        <!--    <th bgcolor="#C2F1A6">TOTA PROGRAMA</th>-->
                            <th bgcolor="#C2F1A6">Utilidad</th>
                            <th bgcolor="#C2F1A6">Margen</th>
				...
				$totales[$n]++;
						 ...
						 <?php
							...
							echo "<td>".number_format($totalServicio,2)."</td>";
								 $prov = $ac['proveedor_id'];	 
						...
						<!--	<td> 
                          ...
                          <?php
							...
							<?php
									...
									$totalPrecioPrograma= $valorPt+$valorMpt;?>
                          <!--<td>
<?php 
						...
						<?php if(!isset($_REQUEST['pag'])){?> 
						 <a href="liquidacion_viajero_facturacion.php?grupo=<?php echo $prospecto['id'];?>&pag=2">Siguiente></a>
						<?php }else{ ?>
						 <a href="liquidacion_viajero_facturacion.php?grupo=<?php echo $prospecto['id'];?>&pag=<?php ($_REQUEST['pag']+1); ?>">Siguiente></a>
						<?php } ?>
                      </div>
                      <h2>&nbsp;</h2>
                      <p>
