...
data-show-export="false"          data-sort-order="desc" class="table table-hover table-fixed">
           				    ...
           				    <thead>
           				      ...
           				      <th>Costeos Aprobados<th>Convertir                              
           				    </thead>
							...
							?>
                             <tr bgcolor="<?php echo $color_estado;?>" class="table table-hover">
     ...
     $dias= floor($datediff/(60*60*24))+1;
							  ...
							  echo strtoupper( $fi['fecha_salida']);?></td>
                               ...
                               <td><form action="gruposprospecto.php" method="post">
                                 <input type="hidden" id="id2" name="id2" value="<?php echo $fi['id']?>">
                                 <input type="hidden" id="reunion2" name="reunion2" value="<?php if(strpos($fi['checklist'],"reunion;") !== false ){
                             ...
                             <?php if(strpos($fi['checklist'],"reunion;") !== false ){ echo 'checked'; }?>
                              ...
                              >
                               ...
                               <td><form action="gruposprospecto.php" method="post">
                                 <input type="hidden" id="id2" name="id2" value="<?php echo $fi['id']?>">
                                 <input type="hidden" id="costeo2" name="costeo2" value="<?php if(strpos($fi['checklist'],"costeo;") !== false ){
                             ...
                             <?php if(strpos($fi['checklist'],"costeo;") !== false ){ echo 'checked'; }?>
                              ...
                              >
                               ...
                               <td><form action="gruposprospecto.php" method="post">
                                 <input type="hidden" id="id2" name="id2" value="<?php echo $fi['id']?>">
                                 <input type="hidden" id="programa2" name="programa2" value="<?php if(strpos($fi['checklist'],"programa;") !== false ){
                             ...
                             <?php if(strpos($fi['checklist'],"programa;") !== false ){ echo 'checked'; }?>
                              ...
                              >
                               ...
                               <td><form action="gruposprospecto.php" method="post">
                                 <input type="hidden" id="id2" name="id2" value="<?php echo $fi['id']?>">
                                 <input type="hidden" id="presentacion2" name="presentacion2" value="<?php if(strpos($fi['checklist'],"presentacion;") !== false ){
                             ...
                             <?php if(strpos($fi['checklist'],"presentacion;") !== false ){ echo 'checked'; }?>
							  ...
							  echo strtoupper($usuario['nombre']);?></td>
                               <td><?php 
								  ...
								  if($fi['estado_aprobacion'.$a]==3){
									  $ap++;
								  }
								   
								  }
								   echo $ap;?></td>
                               <td><?php if($ap>0){?><button type="button" class="btn-xs btn-primary" onClick="location.href='registrar_producto.php?prospecto=<?php echo $fi['id'];?>'">PROGRAMA</button><?php }?>
     ...
     $dias= floor($datediff/(60*60*24))+1;
                             ...
                             <?php if(strpos($fi['checklist'],"presentacion;") !== false ){ echo 'checked'; }?>
                              ...
                              >
           				        ...
           				        <td><?php  $usuario=$control->datosUsuario($fi['encargado']);
							  echo strtoupper($usuario['nombre']);?></td>
           				        <td><button type="button" class="btn-xs btn-primary" onClick="location.href='registrar_producto.php?prospecto=<?php echo $fi['id'];?>'">PROGRAMA</button> <button type="button" class="btn-xs btn-primary" onClick="location.href='gruposprospecto.php?historial=<?php echo $fi['id'];?>&estado=<?php echo $fi['estado'];?>'">HISTORIAL</button></td>
       				          </tr>
           				      <?php
								}
								} ?>
     ...
     $dias= floor($datediff/(60*60*24))+1;
                             ...
                             <?php if(strpos($fi['checklist'],"presentacion;") !== false ){ echo 'checked'; }?>
                              ...
                              >
           				        ...
           				        <td><?php  $usuario=$control->datosUsuario($fi['encargado']);
							  echo strtoupper($usuario['nombre']);?></td>
           				        <td><button type="button" class="btn-xs btn-primary" onClick="location.href='registrar_producto.php?prospecto=<?php echo $fi['id'];?>'">PROGRAMA</button>
           				          <button type="button" class="btn-xs btn-primary" onClick="location.href='gruposprospecto.php?historial=<?php echo $fi['id'];?>&estado=<?php echo $fi['estado'];?>'">HISTORIAL</button></td>
           				        </td>
       				          </tr>
           				      <?php
	...
	$fecha_max= $control->proximaFecha($fi['id']);
     ...
     $dias= floor($datediff/(60*60*24))+1;
                             ...
                             <?php if(strpos($fi['checklist'],"presentacion;") !== false ){ echo 'checked'; }?>
							  ...
							  echo strtoupper($usuario['nombre']);?></td>
           				        <td>
									<?php echo $fi['estado_aprobacion1']; ?>
