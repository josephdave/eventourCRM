                        ...
                        <div class="content">
           				...
           				<div class="module">
           				  ...
           				  <div class="module-body">
                              ...
                              <h2> TRAVELERS REGISTRY</h2>
                              <p>&nbsp;</p>
                              
                          <p align="justify" style="font-size:80%">Following the guidelines of our internal policy and our philosophy on the handling and processing of personal information, we want to confirm that your personal data are treated privately and confidentially and that, therefore, we guarantee the security and confidentiality of your information through secure storage that prevents access to third parties outside our business organization. Your information will be handled in accordance with the provisions of Statutory Law 1581 of 2012 (Personal Data Protection Law).</p>
                          <p align="justify" style="font-size:80%">&nbsp;</p>
                              ...
                              <form action="registro.php#modal" method="post" class="form-horizontal row-fluid" id="registro">
           				        <div class="control-group">
           				          <label class="control-label" for="facdireccion2">Program:</label>
           				          <div class="controls">
           				            <p>
...
?>
							...
							while ($fi = mysql_fetch_array($res, MYSQL_ASSOC)) {?>
                                ...
                                <div class="control-group">
           				          <strong>
           				          <label class="control-label" for="facdireccion2"><strong>Traveler Information:</strong></label>
           				          </strong>
           				        
           				          <div class="controls">
           				              <span class="advertencia"><strong>The fields with (*) are mandatory</strong></span>
           				        ...
           				        <div class="control-group">
           				          <label class="control-label" for="facdireccion">Names*</label>
           				          <div class="controls">
           				        ...
           				        <div class="control-group">
           				          <label class="control-label" for="facdireccion">Document Number*</label>
           				          <div class="controls">
	  ...
	  document.getElementById("facdireccion").value= lista[18];
	   document.getElementById("facemail").value= lista[19];
        ...
        xmlhttp.send();
           				        ...
           				        <div class="control-group">
           				          <label class="control-label" for="basicinput5">Birth Date*</label>
           				          <div class="controls">
...
<option value="1929">1929</option>
  ...
  <option value="1920">1920</option>
                                ...
                                <div class="control-group">
           				          <label class="control-label" for="basicinput3">Program</label>
                                ...
                                <?php } ?>
           				        ...
           				        <div class="control-group">
           				          <label class="control-label" for="basicinput7">Phone Number:</label>
...
<div class="controls">
           				        ...
           				        <div class="control-group">
           				          <label class="control-label" for="basicinput8">Mobile Phone Number*:</label>
           				          <div class="controls">
                                 ...
                                 <div class="control-group">
           				          <label class="control-label" for="basicinput13">Special Conditions:</label>
           				          <div class="controls">
...
Wich: 
       				                  ...
       				                  <br>
       				               if the traveler has any medical condition, special diet, or requirement specific information that we need to know, please specify it, otherwise omit this field</p>
								    <p>
The handling of information on special medical conditions of our travelers is CONFIDENTIAL and will be handled in accordance with the provisions of Statutory Law 1581 of 2012 (Personal Data Protection Act).</p>
           				          </div>
       				            </div>
...
<option value="2024">2024</option>
  ...
  <option value="1970">1970</option>
                                ...
                                <div class="control-group">
           				          <label class="control-label" for="basicinput13">Frecuent Flyer Programs (If aplies)</label>
           				          <div class="controls">
           				            <input name="p2telefono" type="text" class="span8" id="basicinput13" placeholder="">
       				              </div>
       				            </div>
           				        <div class="control-group">
           				          <label class="control-label" for="basicinput14">Frecuent Flyer Number</label>
           				          <div class="controls">
                                  ...
                                  <?php if($contacto_emergencia){?>
           				        <div class="control-group">
           				          <label class="control-label" for="basicinput15"><strong>Emergency Contact</strong></label>
           				          <div class="controls">
Please leave us a contact in case of any eventuality:           				          </div>
       				            </div>
           				        <div class="control-group">
           				          <label class="control-label" for="basicinput13">Name *</label>
           				          <div class="controls">
           				            <input name="p1nombre" type="text" class="span8" id="p1nombre" placeholder="" minlength="4" style="text-transform:uppercase" >
       				              </div>
       				            </div>
           				        <div class="control-group">
           				          <label class="control-label" for="basicinput13">Surnames </label>
           				          *
           				          <div class="controls">
           				        ...
           				        <div class="control-group">
           				          <label class="control-label" for="basicinput13">Phone Number</label>
           				          *
           				          <div class="controls">
  ...
  <div class="controls">
    <input name="acudiente1_documento" type="text" class="span8" id="acudiente1_documento" placeholder="" style="text-transform:uppercase" required>
                                ...
                                <?php if($facturacion){ ?>
           				        <div class="control-group">
           				          <label class="control-label" for="basicinput2"><strong>Billing Information</strong></label>
           				          <div class="controls">Please indicate the details of the person or company to whom cash receipts and invoices must be issued:</div>
           				          <br>
           				        </div>
                                <div class="control-group">
           				          <label class="control-label" for="facdireccion">Name</br>*</label>
           				          <div class="controls">
           				            <input name="facnombre"  id="facnombre" type="text" class="span8" placeholder="" minlength="2" required style="text-transform:uppercase" >
       				              </div>
       				            </div>
           				        <div class="control-group">
           				          <label class="control-label" for="basicinput3">Id Number</label>
	...
	document.getElementById('nit').setAttribute("style", "display: none;");
           				            ...
           				            <p>
           				              <select name="facdocumento" class="span8" id="facdocumento" tabindex="1" data-placeholder="Select here.." onChange="nit()">
           				                ...
           				                <option value="Pasaporte">Pasport</option>
       				                  </select>
		              </p>
           				        ...
           				        <div class="control-group">
           				          <label class="control-label" for="basicinput18">City</label>
           				          *
           				          <div class="controls">
           				            <input type="text" name="facciudad" class="span8" id="facciudad" >
           				             
           				          </div>
       				            </div>
           				        <div class="control-group">
           				          <label class="control-label" for="basicinput4">Address*</label>
           				          <div class="controls">
           				        ...
           				        <?php if($acompanante){?>
                                <div class="control-group">
           				          <label class="control-label" for="basicinput3"><strong>Travel companion</strong></label>
           				          :
           				          <div class="controls">
...
If you travel with a companion you must register your information below
           				          </div>
									 ...
									 EnableSubmit = function(val)
{
        ...
        sbmt.disabled = true;
           				        ...
           				        <div class="control-group">
           				          <div class="controls">
           				            ...
           				            <button type="submit" class="btn"  id="envio" name="envio"> <?php if($contrato){?>Continue<?php } else{?>Continue<?php } ?></button>
       				              </div>
       				            </div>
                             by registering your personal data in this form you authorize EventourSport for the collection, storage and use of the same in order to make the registration and request for all services contracted, as well as to inform you about other events organized by this Entity, related to our functions, about the services we provide, the publications that we elaborate and to request you to evaluate the quality of our services. As Information Holder you have the right to know, update and rectify your personal data, request proof of the authorization granted for your treatment, be informed about the use that has been given to them, file complaints with the SIC for infraction of the law, revoke the authorization and / or request the deletion of your data in the cases where it is appropriate and access them free of charge.
                              </form>
                              <p>
                              <?php } if ($paso==2){?>
  ...
  <p style="font-size:120%;">
    You have been registered with your basic information, if you need to modify any of the entered data you can do it through this link: <a href="https://eventoursport.travel/crm" target="_blank">https://eventoursport.travel/crm</a> with the following access information:<p>
<strong>User:</strong><?php echo $_REQUEST['email'];?><br>
<strong>Password:</strong> <?php echo $_REQUEST['no_docuento'];?><br>
  </p>
  <br>
  ...
  <button data-remodal-action="confirm" class="remodal-confirm">OK</button>
                                 ...
                                 <div style="width:80%;margin:0 auto;">  <h2> VERIFICATION AND SIGNATURE OF ACCEPTANCE</h2>
                                 <p>
...
<?php                                         if($_POST['siacompanante'] == 'si' ){
   ...
   ?>
                                       *<strong>Sing or write your initials with the mouse inside the following box for the acceptance of the program, the contract must be signed by the responsible person to has validity :</p>
                                     <p>
                                       <input type="checkbox" name="checkbox" id="checkbox" checked>
                                       
                                   I have readed and accept the <a href="programas/grupo.php?plan=<?php echo $_REQUEST['plan'];?>" target="_blank">Terms and conditions of the program</a>.<br>
                                    The fact of registering and paying the first installment is the implicit condition that I accept all the terms and conditions of the program</p>
                                   </div>
...
<button type="submit" class="btn" disabled  id="envio" name="envio"> Continue</button>
...
$('#envio').prop('disabled',false); // append the image (SVG) to DOM.
						...
						<div style="width:80%;margin:0 auto;">  <h2> YOUR AGREEMENT</h2>
                                 <p>
                              ...
                              <p> Download your agreement here  <a href="https://eventoursport.travel/crm/impresion/pdf/contrato_pdf.php?firma=<?php echo $_REQUEST['document']?>&carta_aceptacion=<?php echo $carta_aceptacion;?>" target="_blank">DOWNLOAD</a>. <br>
                               </p>
                              </p>
  ...
  <div class="control-group">
    <div class="controls">
      <button type="submit" class="btn" id="enviar2" name="enviar">Continue</button>
      &nbsp;   &nbsp;</div>
</div>
                              </form>
                              <p>
   ...
   ?>
    ...
    padding: 10px;"><strong>RUT</strong><br>
                           ...
                           &nbsp;   &nbsp;      
                                    <button type="submit" class="btn" id="enviar" name="enviar" style="background-color:#aab5fd !important">DO NOT HAVE THE DOCUMENTS YET</button>
                                    *You can send them later
                                  </div>
                                </div>
                              </form>
                              <p>&nbsp;</p>
                              <p>
                                <?php } if($paso == 5 ){
									...
									if($unidadnegocio == 'GRUPOS JUVENILES' || $_POST['plan']==206){
									/*
									$ch = curl_init(); 
...
*/
										...
										sendEmail($_POST['email'],$_POST['email'],$_POST['plan'],str_replace(" ","_",$datos_producto['grupo']));
		...
		?>
                             ...
                             Your data has been successfully registered, if you wish to update, your documents or verify your registered information enter with the traveler's email and document number in following link: <a href="https://eventoursport.travel/crm/"><strong>https://eventoursport.travel/crm/</strong></a></p>
                              <p><strong>User : <?php echo $_POST['email']?><br>
                             Password : <?php echo $_POST['document']?></strong></p>
                             <?php if(isset($_POST['acompanante_de'])){ ?> 
                             <br>
                             <p><a href="registro.php?ac=<?php echo $_POST['acompanante_de']; ?>&plan=<?php echo $_REQUEST['plan']?>" style="background:#006;color:#FFF;padding:6px;">Register companion</a><strong><?php } ?>
                                <?php } ?>
                              </strong></p>
           				    </div>
       				      </div>
