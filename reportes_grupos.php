					  ...
					  <tr>
					    <td><table data-toggle="table" data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="false" data-sort-name="producto" data-sort-order="desc" class="table table-hover">
					      ...
					      <tr>
					        ...
					        <td>
								<button type="button" class="btn-xs btn-primary" onClick="location.href='reporte_fecha.php?id=<?php echo $fi['id'];?>'">FECHA INSCRIPCION</button>
								<button type="button" class="btn-xs btn-primary" onClick="location.href='reporte_observaciones.php?id=<?php echo $fi['id'];?>'">OBSERVACIONES</button>
