					  ...
					  <table data-toggle="table" data-show-refresh="false" data-show-toggle="false" data-show-columns="false" data-search="false" data-pagination="false" data-sort-name="producto" data-sort-order="desc" class="table table-hover table-fixed" style="height:700px;">
					    <thead>
					      <tr>
							...
							$totales = array();
							while ($fi4 = mysql_fetch_array($resultado4, MYSQL_ASSOC)) {//($fi4['categoria'] != "TIQUETES")&&
								if(($fi4['categoria'] != "PROMOCION")&&($fi4['categoria'] != "GUIAS")&&($fi4['categoria'] != "OTROS")&&($fi4['categoria'] != "COMISIONES") && (strpos($fi4['tarifa'],"-1") === false) ){
							?>
							...
							$prov=	$control->datosProveedor($fi4['proveedor_id']);
							echo substr($fi4['nombre'],0,20);
								echo "<br/>".$prov['nombre']; ?></p></th>
