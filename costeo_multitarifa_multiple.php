...
var table_html = table_html.replaceAll(',', ',');	
	...
	//							 var_dump($control->impuestosRecord($contratoAerolinea['id_sillas']));
							...
							//  $total_unit_cat=$total_unit_cat+$unitatio;
							  ...
							  echo number_format($unitatio,2,",",".");
							  $total_grupo[$pax][$cat]=$total_grupo[$pax][$cat]+$grupo;
							  $total_grupo_cat[$pax][$cat]=$total_grupo_cat[$pax][$cat]+$grupo;
							  $total_unit[$pax][$cat]=$total_unit[$pax][$cat]+$unitatio;
								
								if ( $cat != "TIQUETES"){
								$total_unit_pt[$pax][$cat]=$total_unit_pt[$pax][$cat] + $unitatio;
		  }	else {
									$total_unit_tk[$pax][$cat]=$total_unit_tk[$pax][$cat]+$unitatio;
							  ...
							  $total_unit_cat[$pax][$cat]=$total_unit_cat[$pax][$cat]+$unitatio;
							  ?>
							  ...
							  echo number_format($unitatio,2,",",".");
							  $total_grupo[$viajeros][$cat]=$total_grupo[$viajeros][$cat]+$grupo;
							  $total_grupo_cat[$viajeros][$cat]=$total_grupo_cat[$viajeros][$cat]+$grupo;
							  $total_unit[$viajeros][$cat]=$total_unit[$viajeros][$cat]+$unitatio;
								
								if ( $cat != "TIQUETES"){
								$total_unit_pt[$viajeros][$cat]=$total_unit_pt[$viajeros][$cat] + $unitatio;
		  }	else {
									$total_unit_tk[$viajeros][$cat]=$total_unit_tk[$viajeros][$cat]+$unitatio;
									if($fi['nombre']=="TA"||$fi['nombre']=="TASA ADMINISTRATIVA"){
									$ta[$viajeros]+=$unitatio;
									}
									//var_dump($total_unit_tk);
								}

							  $total_unit_cat[$viajeros][$cat]=$total_unit_cat[$viajeros][$cat]+$unitatio;
							  ?></td>
	...
	if(mysql_num_rows($resultado)>0){
                               ...
                               <td class="totales">&nbsp;</td>
								 ...
								 <td align="right" class="numeros"><strong><?php 
															...
															echo number_format($total_unit_cat[$pax][$cat],2,",",".")?></strong></td>
								 <?php }?>
                               <td align="right" class="numeros"><strong><?php echo number_format($total_unit_cat[$viajeros][$cat],2,",",".")?></strong></td>
                               <td align="right" class="numeros"><strong><?php echo number_format($total_grupo_cat[$viajeros][$cat],2,",",".") ?></strong></td>
                               <td >&nbsp;</td>
                             </tr>
                          ...
                          <?php }?>
								  ...
								  foreach($pax_num as $pax){?>
								 <td align="right" class="directos"><?php 
														//	var_dump($total_unit_pt);
															echo number_format(array_sum($total_unit_pt[$pax]),2,",",".");?></td>
								 <?php }?>
                                <td align="right" class="directos"><strong><?php echo number_format(array_sum($total_unit_pt[$viajeros]),2,",",".");?></strong></td>
                               <td align="right" class="directos"><strong>
								   <?php echo number_format(array_sum($total_grupo[$viajeros]),2,",",".");?>
								  </strong></td>
                               <td>&nbsp;</td>
                             </tr>
                          <!--     <tr>
	 ...
	 $resultado=$control->costeoListaProdPROSPECTO($_REQUEST['id_prospecto'],'COMISIONES',$multi);
							...
							<?php }else{?>
							  ...
							  if($fi['tipo_costo'] == 'COMISION'){
							  $unitatio= $fi[$tipo_costo]*((array_sum($total_unit_pt[$viajeros]))/100);
							  $grupo= $unitatio*$viajeros;
							  }
							//  var_dump($fi);
							//  var_dump($tipo_costo);
							 ...
							 // $unitatio= $fi[$tipo_costo]*(($total_unit-$total_tk)/100);
							  ...
							  $grupo= $unitatio*$viajeros;	
								 ...
								 if($fi['tipo_costo'] == 'COSTO FINANCIERO' && (strtoupper($fi['nombre']) == 'COSTO FINANCIERO' || strtoupper($fi['nombre']) == 'GASTOS BANCARIOS POR RECAUDO')){
									 		  ...
									 		  $unitatio= $fi[$tipo_costo]*((array_sum($total_unit_pt[$pax])+array_sum($total_unit_tk[$pax]))/100);//AQUI
								//  var_dump($unitatio);
							  $grupo= $unitatio*$viajeros;	
									 }
							//	var_dump($viajeros);
							  echo number_format($unitatio,2,",",".");
							  $comision_grupo[$pax][$cat]=$comision_grupo[$pax][$cat]+$grupo;
							  $comision_unit[$pax][$cat]=$comision_unit[$pax][$cat]+$unitatio;
							 ...
							 // $unitatio= $fi[$tipo_costo]*(($total_unit-$total_tk)/100);
							  ...
							  $grupo= $unitatio*$viajeros;	
								 ...
								 if($fi['tipo_costo'] == 'COSTO FINANCIERO' && (strtoupper($fi['nombre']) == 'COSTO FINANCIERO' || strtoupper($fi['nombre']) == 'GASTOS BANCARIOS POR RECAUDO')){
									 		  ...
									 		  $unitatio= $fi[$tipo_costo]*((array_sum($total_unit_pt[$viajeros])+array_sum($total_unit_tk[$viajeros]))/100);//AQUI
								  //var_dump($unitatio);
							  $grupo= $unitatio*$viajeros;	
									 }
							//	var_dump($viajeros);
							  echo number_format($unitatio,2,",",".");
							  $comision_grupo[$viajeros][$cat]=$comision_grupo[$viajeros][$cat]+$grupo;
							  $comision_unit[$viajeros][$cat]=$comision_unit[$viajeros][$cat]+$unitatio;
							// $total_unit_pt=$total_unit_pt + $unitatio;
							  ?></td>
                               <td align="right"><?php echo  number_format($grupo,2,",",".");?></td>
                               <td>
	...
	?>
                              ...
                              <?php } ?>
                               ...
                               <td class="totales">&nbsp;</td>
								 ...
								 <td align="right" class="numeros"><strong><?php 
															...
															echo number_format($comision_unit[$pax][$cat],2,",",".")?></strong></td>
								 <?php }?>
                               <td align="right" class="numeros"><strong><?php echo number_format($comision_unit[$viajeros][$cat],2,",",".")?></strong></td>
                               <td align="right" class="numeros"><strong><?php echo number_format($comision_grupo[$viajeros][$cat],2,",",".") ?></strong></td>
                               <td >&nbsp;</td>
                             </tr>
                                ...
                                <tr>
								  ...
								  foreach($pax_num as $pax){?>
								 <td align="right" class="directos">  <?php 
								  echo number_format(array_sum($comision_unit[$pax])+array_sum($total_unit_pt[$pax]),2,",","."); ?></td>
								 <?php }?>
                                  <td align="right" class="directos"><strong>
                                    <?php $subtotal[$viajeros]=array_sum($comision_unit[$viajeros])+array_sum($total_unit_pt[$viajeros]);
								  echo number_format($subtotal[$viajeros],2,",","."); ?>
                                  </strong></td>
                                  <td align="right" class="directos"><strong>
                                    <?php  $subtotalg[$viajeros]=array_sum($comision_grupo[$viajeros])+array_sum($total_grupo[$viajeros]);
								  echo number_format($subtotalg[$viajeros],2,",","."); ?>
                                  </strong></td>
                                  <td >&nbsp;</td>
                                </tr>
                                <tr id="detalle_costos" >
                                 ...
                                 <?php }?>
								  ...
								  foreach($pax_num as $pax){?>
								 <td align="right"><strong><?php $subtotal[$pax]=array_sum($comision_unit[$pax])+array_sum($total_unit_pt[$pax]);
								  echo number_format($subtotal[$pax]*0.31,2,",","."); ?></strong></td>
								 <?php }?>
                                  <td align="right"><strong><?php $subtotal[$viajeros]=array_sum($comision_unit[$viajeros])+array_sum($total_unit_pt[$viajeros]);
								  echo number_format($subtotal[$viajeros]*0.31,2,",","."); ?></strong></td>
                                  <td align="right"><strong><?php  $subtotalg[$viajeros]=array_sum($comision_grupo[$viajeros])+array_sum($total_grupo[$viajeros]);
								  echo number_format($subtotalg[$viajeros]*0.31,2,",","."); ?></strong></td>
                                  <td>&nbsp;</td>
                                </tr>
                                <tr id="detalle_costos2" >
								  ...
								  foreach($pax_num as $pax){?>
								  <td align="right"><strong><?php echo number_format($subtotal[$pax]+($subtotal[$pax]*0.31),2,",",".")?></strong></td>
                                 <?php }?>
                                  <td align="right"><strong><?php echo number_format($subtotal[$viajeros]+($subtotal[$viajeros]*0.31),2,",",".")?></strong></td>
                                  <td align="right"><strong><?php echo number_format($subtotalg[$viajeros]+($subtotalg[$viajeros]*0.31),2,",",".") ?></strong></td>
                                  <td>&nbsp;</td>
                                </tr>
                                ...
                                <tr>
								  ...
								  foreach($pax_num as $pax){?>
								 <td align="right" class="directos"><strong>
                                    <?php $subtotal[$pax]=array_sum($total_unit_tk[$pax])-$ta[$pax];
									//  var_dump($total_unit_tk);
								  echo number_format($subtotal[$pax],2,",","."); ?>
                                  </strong></td>
								 <?php }?>
                                  <td align="right" class="directos"><strong>
                                    <?php $subtotal[$viajeros]=array_sum($total_unit_tk[$viajeros])-$ta[$viajeros];
									//  var_dump($total_unit_tk);
								  echo number_format($subtotal[$viajeros],2,",","."); ?>
                                  </strong></td>
                                  <td align="right" class="directos"><strong>
                                    <?php  $subtotalg[$viajeros]=(array_sum($total_unit_tk[$viajeros])-$ta[$viajeros])*$viajeros;
								  echo number_format($subtotalg[$viajeros],2,",","."); ?>
                                  </strong></td>
                                  <td >&nbsp;</td>
                                </tr>
                                <tr id="detalle_tiq" style="display: none">
								 ...
								 <td align="right"><strong>
								   <?php $subtotal[$pax]=$ta[$pax];
								//	  var_dump($total_unit_tk);
								  echo number_format($subtotal[$pax],2,",","."); ?>
								 </strong></td>
								 <?php }?>
                                  <td align="right"><strong>
                                    <?php $subtotal[$viajeros]=$ta[$viajeros];
								//	  var_dump($total_unit_tk);
								  echo number_format($subtotal[$viajeros],2,",","."); ?>
                                  </strong></td>
                                  <td align="right"><strong>
                                    <?php  $subtotalg[$viajeros]=($ta[$viajeros])*$viajeros;
								  echo number_format($subtotalg[$viajeros],2,",","."); ?>
                                  </strong></td>
                                  <td>&nbsp;</td>
                                </tr>
                                <tr id="detalle_tiq2" style="display: none">
								  ...
								  foreach($pax_num as $pax){?>
								 <td align="right"><strong>
								   <?php $subtotal[$pax]=array_sum($total_unit_tk[$pax]);
								//	  var_dump($total_unit_tk);
								  echo number_format($subtotal[$pax],2,",","."); ?>
								 </strong></td>
								 <?php }?>
                                  <td align="right"><strong>
                                    <?php $subtotal[$viajeros]=array_sum($total_unit_tk[$viajeros]);
								//	  var_dump($total_unit_tk);
								  echo number_format($subtotal[$viajeros],2,",","."); ?>
                                  </strong></td>
                                  <td align="right"><strong>
                                    <?php  $subtotalg[$viajeros]=(array_sum($total_unit_tk[$viajeros]))*$viajeros;
								  echo number_format($subtotalg[$viajeros],2,",","."); ?>
                                  </strong></td>
                                  <td>&nbsp;</td>
                                </tr>
                                ...
                                <tr>
								  ...
								  foreach($pax_num as $pax){?>
								 <td align="right" class="resultados"> <?php  echo number_format($precioFinal,2,",",".") ?></td>
								 <?php }?>
                                  <td align="right" class="resultados">
								 <?php  echo number_format($precioFinal,2,",",".") ?></td>
								 ...
								 // echo number_format((($precioFinal-$total_unit_pt)/($total_unit_pt+$comision_unit))*100,0,".",","); 
								  ?>
									  <?php
								  echo number_format((($precioFinal-array_sum($total_unit_pt[$viajeros])-array_sum($comision_unit[$viajeros]))/($precioFinal))*100,0,".",","); 
								  ?>% </td>
                                    <?php if(!isset($_REQUEST['id_prospecto'])){?><td align="right">&nbsp;</td>
								  ...
								  foreach($pax_num as $pax){?>
								 <td align="right"><?php  echo number_format($precioFinal-array_sum($total_unit_pt[$pax])-array_sum($comision_unit[$pax]),2,",",".");?></td>
								 <?php }?>
                                  <td align="right"><?php  echo number_format($precioFinal-array_sum($total_unit_pt[$viajeros])-array_sum($comision_unit[$viajeros]),2,",",".");?></td>
                                  <td align="right"><?php  echo number_format(($precioFinal-array_sum($total_unit_pt[$viajeros])-array_sum($comision_unit[$viajeros]))*$viajeros,2,",",".");?></td>
                                  <td>&nbsp;</td>
                                </tr>
						        ...
						        <tr id="detalle_margentk" style="display: none">
						          ...
						          <td>MARGEN DE CONTRIBUCIÓN TK (ACTUAL)
						            <?php
								  echo number_format((($precioFinaltk-(array_sum($total_unit_tk[$viajeros])-$ta[$viajeros]))/(array_sum($total_unit_tk[$viajeros])-$ta[$viajeros]))*100,0,".",","); 
								  ?>
						            % </td>
						          <?php if(!isset($_REQUEST['id_prospecto'])){?>
						          <td align="right">&nbsp;</td>
								  ...
								  foreach($pax_num as $pax){?>
								 <td align="right"><?php  echo number_format($precioFinaltk-(array_sum($total_unit_tk[$pax])-$ta[$pax]),2,",",".");?></td>
								 <?php }?>
						          <td align="right"><?php  echo number_format($precioFinaltk-(array_sum($total_unit_tk[$viajeros])-$ta[$viajeros]),2,",",".");?></td>
						          <td align="right"><?php  echo number_format(($precioFinaltk-(array_sum($total_unit_tk[$viajeros])-$ta[$viajeros]))*$viajeros,2,",",".");?></td>
						          <td>&nbsp;</td>
					          </tr>
                                ...
                                <tr>
								 ...
								 // echo number_format((($precioFinaltotal-(($total_unit_tk-$ta)+$total_unit_pt))/(($total_unit_tk-$ta)+$total_unit_pt+$comision_unit))*100,0,".",","); 
									  ...
									  echo number_format((($precioFinaltotal-((array_sum($total_unit_tk[$viajeros])-$ta[$viajeros])+array_sum($total_unit_pt[$viajeros])+array_sum($comision_unit[$viajeros])))/$precioFinaltotal)*100,0);
								  ?>
                                    % </td>
                                  <?php if(!isset($_REQUEST['id_prospecto'])){?>
								  ...
								  foreach($pax_num as $pax){?>
								 <td align="right" class="contribucion"><span class="contribucion">
								   <?php  echo number_format($precioFinaltotal-((array_sum($total_unit_tk[$pax])-$ta[$viajeros])+array_sum($total_unit_pt[$pax])+array_sum($comision_unit[$pax])),2,",",".");?>
								 </span></td>
								 <?php }?>
                                  <td align="right" class="contribucion"><?php  echo number_format($precioFinaltotal-((array_sum($total_unit_tk[$viajeros])-$ta[$viajeros])+array_sum($total_unit_pt[$viajeros])+array_sum($comision_unit[$viajeros])),2,",",".");?></td>
                                  <td align="right" class="contribucion"><?php  echo number_format(($precioFinaltotal-((array_sum($total_unit_tk[$viajeros])-$ta[$viajeros])+array_sum($total_unit_pt[$viajeros])+array_sum($comision_unit[$viajeros])))*$viajeros,2,",",".");?></td>
                                  <td >&nbsp;</td>
                                </tr>
								  <tr>
                                  <td>&nbsp;</td>
           				   ...
           				   <form action="costeo_multitarifa_multiple.php" method="post" name="form1" id="form1">
                            <?php 
       ...
       <input type="hidden" name="id_servicio" id="id_servicio" placeholder="" value="<?php echo $id_servicio ?>">                         
                         ...
                         <select name="servicio" id="servicio" class="servicio" style="width: 200px">
                           ...
                           <tr>
       				        ...
       				        <form action="costeo_multitarifa_multiple.php" method="post" name="form1" id="form3">
       				          <?php 
							$servicio=$control->consultaServicioID($id_servicio);	
	...
	$usu= $control->datosUsuario($_SESSION['id']);
							   ...
							   ?>
           				   <form action="costeo_multitarifa_multiple.php" method="post" name="form1" id="form2">
