...
$viajeros=$control->cantGrupoViaja($grupo);
...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">	
          ...
          <thead>
				...
				if($t==0 && $t!=""){
					$va=true;
							  ...
							  $unitatio= ($fi[$tipo_costo]/100)*$programa_pt;
							  $grup= $fi[$tipo_costo];
							  }
								if($fi['tipo_costo'] == 'COSTO FINANCIERO'){
							  $unitatio= ($fi[$tipo_costo]/100)*($programa_pt+$programa_tk);
							  $grup= $fi[$tipo_costo];
							  }
							  ...
							  $totalcostop= $unitatio*$total_usuarios;
							  
							  $totalproveedor = $totalproveedor+$totalcostop;
							  
								 echo number_format($totalcostop,2,",",".");
								//echo $totalcostop;?> </td>
                              <td><?php 
  ...
  <input type="submit" value="Modificar">
                            ...
                            <tr style="background:#333">
                              ...
                              <td bgcolor="#CCCCCC"><?php echo number_format($totalproveedorreal,2);?></td>
