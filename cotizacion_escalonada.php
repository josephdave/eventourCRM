...
var table_html = table_html.replaceAll(',', ',');	
	...
	if(mysql_num_rows($resultado)>0){
                               ...
                               <td class="totales">&nbsp;</td>
                                 <?php if(!isset($_REQUEST['id_prospecto'])){?><td align="right" class="numeros">&nbsp;</td><?php } ?>
                          ...
                          <?php if(!isset($_REQUEST['id_prospecto'])){?>   <td align="right" class="directos">&nbsp;</td><?php }?>
                               ...
                               <td>&nbsp;</td>
                                ...
                                <tr>
                                  ...
                                  <td class="resultados">PRECIO VENTA REAL PT</td>
                                    <?php if(!isset($_REQUEST['id_prospecto'])){?><td align="right" class="resultados">&nbsp;</td><?php }?>
