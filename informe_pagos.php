					...
					<div class="panel-body">
                          ...
                          <table class="table table-hover" border="1" bordercolor="#000000" cellpadding="10" cellspacing="0"  data-toggle="table" data-show-refresh="false" data-show-toggle="false" data-show-columns="true" data-search="true"  data-filter-control="true" data-pagination="false" data-sort-name="viajeros" data-sort-order="desc" data-side-pagination="client" data-fixed-header="true" >
							...
							while ($fd = mysql_fetch_array($resulto, MYSQL_ASSOC)) {
								...
								$viajeros=$control->inscritosVIAJA($fd['id']);
							//if($fd['estado'] == "ACEPTADO" && $fd['unidad_negocio'] == "GRUPOS JUVENILES"){
							if(($fd['estado'] == "ACEPTADO" || $fd['estado'] == "HISTORIAL") && mysql_num_rows ( $viajeros ) >0){
								
								?>
							  <?php if($monContr!=$fd['MONEDA']){?>
							      <tr style="background: #f0f0f0;">
                              <td bgcolor="#979797"><strong>TOTAL</strong></td>
                              <td bgcolor="#979797">&nbsp;</td>
                              <td bgcolor="#979797">&nbsp;</td>
                              <td bgcolor="#979797"><strong><?php echo $totalesfinales[7];
							   ?></strong></td>
                              <td bgcolor="#979797"><strong><?php echo $monContr;
							   ?></strong></td>
                              <td bgcolor="#979797"><strong><?php echo number_format($totalesfinales[0],1,",",".");
							   ?></strong></td>
                              <td bgcolor="#979797"><strong><?php echo number_format($totalesfinales[1],1,",",".");
							   ?></strong></td>
                              <td bgcolor="#979797"><strong><?php echo number_format($totalesfinales[2],1,",",".");
							   ?></strong></td>
                              <td bgcolor="#979797"><strong><?php echo number_format($totalesfinales[3],1,",",".");
							   ?></strong></td>
                              <td bgcolor="#979797"><strong><?php echo number_format($totalesfinales[4],1,",",".");
							   ?></strong></td>
                              <td bgcolor="#979797"><strong><?php echo number_format($totalesfinales[5],1,",",".");
							   ?></strong></td>
                              <td bgcolor="#979797"><strong><?php echo number_format($totalesfinales[6],1,",",".");
							   ?></strong></td>
						    </tr>
							  <?php 
																 $monContr = $fd['MONEDA'];
							...
							$resultado=$viajeros;
								...
								$gtotalviajeros =mysql_num_rows ( $resultado );
                            ...
                            <?php 				  $gtotalsaldo+=$aereo_base+$ModificacionesTK+$terrestre_base+$ModificacionesPT-$pagosPT-$pagosTK;?><?php 							   $gtotaltk+=$aereo_base+$ModificacionesTK;  ?><?php $gtotalpagostk+=$pagosTK; ?><?php $gtotalpt+=$terrestre_base+$ModificacionesPT; ?><?php $gtotalpagospt+=$pagosPT; ?>                             <tr>
                               ...
                               <td><strong><a href="pagos.php?grupo=<?php echo $fd['id']?>"><?php echo $fd['f_salida']?></a></strong></td>
							   ...
							   ?></strong></td>
                               <td><?php echo $producto['MONEDA']."$ ";
							   
							   $totalesfinales[1]+=$gtotaltk;?></td>
                               <td><?php echo number_format($gtotalsaldo,1,",",".");
							   $totalesfinales[0]+=$gtotalsaldo;
							   ?></td>
                               <td><?php echo number_format($gtotaltk,1,",",".");
							   
							   $totalesfinales[1]+=$gtotaltk;?>
                               </td>
                               <td><?php echo number_format($gtotalpagostk,1,",",".");
							   
							   $totalesfinales[2]+=$gtotalpagostk;?></td>
                               <td><?php echo number_format(($gtotaltk-$gtotalpagostk),0,",",".");
							   
							   $totalesfinales[3]+=$gtotaltk-$gtotalpagostk;
							   ?></td>
                               <td><?php echo number_format($gtotalpt,1,",",".");
							   
							   
							   $totalesfinales[4]+=$gtotalpt;
							   ?></td>
                               <td><?php echo number_format($gtotalpagospt,1,",",".");
							   
							   
							   $totalesfinales[5]+=$gtotalpagospt;?></td>
                               <td><?php echo number_format(($gtotalpt-$gtotalpagospt),1,",",".");
                           ...
                           <table class="table table-hover" border="1" bordercolor="#000000" cellpadding="10" cellspacing="0"  data-toggle="table" data-show-refresh="false" data-show-toggle="false" data-show-columns="true" data-search="true"  data-filter-control="true" data-pagination="false" data-sort-name="viajeros" data-sort-order="desc" data-side-pagination="client" data-fixed-header="true" >
							...
							while ($fi = mysql_fetch_array($resultado, MYSQL_ASSOC))
                             ...
                             <tr>
                               ...
                               <td><?php echo number_format($gtotalsaldo,1,",",".");?></td>
                               <td><?php echo number_format($gtotaltk,1,",",".");?></td>
                               <td><?php echo number_format($gtotalpagostk,1,",",".");?></td>
                               <td><?php echo number_format(($gtotaltk-$gtotalpagostk),0,",",".");?></td>
                               <td><?php echo number_format($gtotalpt,1,",",".");?></td>
                               <td><?php echo number_format($gtotalpagospt,1,",",".");?></td>
                               <td><?php echo number_format(($gtotalpt-$gtotalpagospt),1,",",".");?></td>
                             </tr>
                             <?php }} ?>
                           </table>
                           </div>
