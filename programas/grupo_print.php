...
<h2>Servicios Incluidos</h2>
			    <?php $text= str_replace("<div>&nbsp;</div>","",str_replace("<p>&nbsp;</p>","",$producto['incluye']));
	echo $text;			
	//echo ereg_replace("<p.*>&nbsp;</p>","",$text);
	?>
...
<?php $resultado5=$control->consultaCalendarioPagos($plan);
		//	 var_dump(sizeof($resultado5));
if(sizeof($resultado5)>1){	
	?>
...
<strong>Pago Botón PSE BANCOLOMBIA</strong><p>Esta opción esta habilitada, con cargo a su cuenta de ahorros o corriente de cualquier banco, sin  costo adicional. El Boton PSE permite hacer el pago de la totalidad de Tiquetes y Porción Terrestre. Si usted elige esta opción ingrese directamente al portal de pago a través del siguiente botón: <br>
  ...
  <p>Enviar soporte de consignación al correo <a href="mailto:camilo.rodriguez@eventours.travel">camilo.rodriguez@eventours.travel</a> . Incluir en el asunto del correo, el nombre del viajero  y el grupo al que pertenece.</p>
...
<p>Importante: Es indispensable que por favor nos remita la copia de la  consignación sellada que le entrega el banco, a nuestro correo <a href="mailto:camilo.rodriguez@eventours.travel">camilo.rodriguez@eventours.travel</a> para poder registrar el abono. Favor especificar en el  asunto Nombre Completo del Viajero y grupo, de lo contrario el pago no se vera  reflejado.</p>
...
<ul>
  ...
  <li>EventourS brindará de manera individual a cada viajero la cobertura de servicios  médicos prestados por Grupo MOK y detallados en el programa  completo, durante todos  los días que  el progama de viaje dure.</li>
</ul>
...
<ul>
  ...
  <li>En caso de que el grupo decida dividir el  valor del Tour Conductor en partes iguales para todos los viajeros, el Grupo  deberá informarlo de manera escrita al correo <a href="mailto:camilo.rodriguez@eventours.travel">camilo.rodriguez@eventours.travel</a> y EventourS, reintegrará el dinero equivalente en efectivo en nombre  de un alumno aleatorio que el Grupo le suministre. </li>
...
<ol>
  ...
  <ul>
    <li>Después de emitidos los tiquetes, los cambios  de ruta, vuelos o fechas deberán manejarse por medio de la reexpedición de los  boletos (tiquetes) tomando como base las tarifas publicadas de pasajeros  individuales vigentes para ese itinerario. Cambio sujeto al pago de penalidades y diferencias de  tarifas correspondientes.</li></ul></ol><?php } ?>
<strong>TARJETA ASISTENCIA<br>
COBERTURA 
AssitCard/Eventour 60.000L<u></u><u></u></strong>
<p>AssitCard/Eventour 60.000  esta presente en 37 países, cuenta con más de 45 compañías dedicadas a múltiples ramas de la industria de los seguros y servicios de asistencia. asesora, diseña, gestiona y comercializa pólizas a través de una estrategia multicanal. Es el Corredor de Seguros mayorista No. 1 en Francia  (Propiedades y Accidentes).</p>
