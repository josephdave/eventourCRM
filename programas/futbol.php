...
<body id="home">
    ...
    vertical-align: middle;    height: 126px;">
			<h1 style="font-size:161%;text-align:left;"><img src="25/partido.jpg"  alt="" width="708" height="130"/></h1>
            </div>
			<p>&nbsp;</p>
		<!--	<nav>
...
$meses = array("","Enero","Febrero","Marzo","Abril","Mayo","Junio","Julio","Agosto","Septiembre","Octubre","Noviembre","Diciembre");
     ...
     $dias= floor($datediff/(60*60*24))+1;
					if($dias == 1){ 
					echo $llegada->format("j")." de ".$meses[$llegada->format("n")]." de ".$llegada->format("Y"); }else{
					
					echo "".$salida->format("j")." a ".$llegada->format("j")." de ".$meses[$llegada->format("n")]." de ".$llegada->format("Y");
					}
					?></p></td>
			      </tr>
				  <tr>
		  ...
		  <div class="clearfix"></div>
			...
			<div id="about">
			  ...
			  <div class="accordion">
			   ...
			   <h2>PARTIDOS EN COLOMBIA</h2>
			        <p> Cédula de ciudadanía</p>
		             <p>&nbsp;</p>
                         <h2>PARTIDOS FUERA DE COLOMBIA</h2><p>Pasaporte al día, con vigencia mínima de 6 meses.<br>
			        <p>&nbsp;</p>
