		...
		<section id="main-content">
			<div id="featured">
			  <table width="100%" border="1" cellpadding="0">
			    <tr>
				    <th colspan="2"><p align="center"><strong>Trip Information</strong></p></th>
			    </tr>
				  <tr>
				    <td width="204" valign="top"><p><strong>Travel Date</strong></p></td>
...
$meses = array("","January","February","March","April","May","June","July","August","September","October","November","December");
 setlocale(LC_TIME, "en_US"); 
     ...
     $dias= floor($datediff/(60*60*24))+1;
					...
					echo "From ".$salida->format("j")." ".$meses[$salida->format("n")]." to ".$llegada->format("j")."  ".$meses[$llegada->format("n")]." ".$llegada->format("Y")?></p></td>
			      </tr>
				  <tr>
				    <td valign="top"><p><strong>From</strong></p></td>
				    <td valign="top"><p align="center"><?php echo $producto['origen']?></p></td>
			    </tr>
				  <tr>
				    <td width="204" valign="top"><p><strong>Destination</strong></p></td>
				    <td width="463" valign="top"><p align="center"><?php echo $producto['destino']?></p></td>
			      </tr>
				  <tr>
				    <td width="204" valign="top"><p><strong>Days</strong></p></td>
				    <td width="463" valign="top"><p align="center">
						<?php if($producto['id']== 183){echo "12 dias - 10 noches";}else{
						?><?php echo $dias; ?> days - <?php echo $dias-1; ?> nights <?php }?></p></td>
			      </tr>
                  <?php $hot=$control->nombreHoteles($plan);
				  if($hot!=""){?>
				  <tr>
				    <td width="204" valign="top"><p><strong>Program cost</strong></p></td>
				 ...
				 ?>
				    <td width="204" valign="top"><p><strong>Program Value</strong></p></td>
			  ...
			  <div id="noprint">  <p><a href="#"></a>One of the most important aspects in this process is having travelers information. These data will be used to send periodic bulletins with information on the progress of the program, and also to keep a strict control of travel documents, payments, balances, etc. A clear and complete record of the information of each participant is required. Please to register, click on the following button:</p>
              <p>&nbsp;</p>
              <p align="center"><a href="https://eventoursport.travel/crm/registro_eng.php?plan=<?php echo $plan?>" target="_blank" class="myButton">Subscribe </a></p>
              <p align="center">&nbsp;</p>
              <p align="center" style="font-size:80%">ollowing the guidelines of our internal policy and our philosophy regarding the handling and processing of personal information, we want to confirm that your personal data is treated privately and confidentially and that, therefore, we guarantee the security and confidentiality of your information through a secure storage that prevents access to third parties outside our business organization.</p>
              <p align="center">&nbsp;</p>
          </div></div> 
		  ...
		  <div class="clearfix"></div>
			<hr/>
			<div id="about">
			  <h3 id="grupo">GENERAL INFORMATION</h3>
			  <p>&nbsp;</p>
			  <div class="accordion">
			    <div class="accordion-section"> <a class="accordion-section-title" href="#accordion-1">INCLUDED SERVICES</a>
              ...
              <div class="accordion-section"> <a class="accordion-section-title" href="#accordion-calen">PROGRAM COSTS</a>
              ...
              <!--end .accordion-section-content-->
               ...
               <?php } else { ?> <div class="accordion-section"> <a class="accordion-section-title" href="#accordion-2">Program Costs</a>
			      <div id="accordion-2" class="accordion-section-content">
			        <table border="1" cellpadding="0" width="514">
			          <tr>
			            <th width="427" valign="top"><p align="center">PROGRAM COSTS PER TRAVELER</p></th>
			            <th width="81" valign="top"><p align="center"><strong> <?php if ($producto['nombre_tarifa1'] != '' && $producto['nombre_tarifa1'] != 'Programa'){ echo $producto['nombre_tarifa1']; }else{ ?><?php } ?></strong></p></th>
                        <?php if ($producto['nombre_tarifa2'] != '' ){?>
			          ...
			          <tr>
			            <td width="427" valign="top"><p><strong>ground services</strong></p></td>
        ...
        <td width="81" valign="top"><p align="right"><strong><?php echo $moneda." ".number_format($producto['valor_terrestre_tarifa10'],0,".",".")?> </strong></p></td>                    
			          ...
			          <tr>
			            <td width="427" valign="top"><p><strong>Air Fare</strong></p></td>
      ...
      <?php } ?>   
        ...
        <td width="81" valign="top"><p align="right"><strong><?php echo $moneda." ".number_format($producto['valor_aereo_tarifa10'],0,".",".")?> </strong></p></td>
			          ...
			          <tr>
			            <td width="427"><p><strong>Total Cost</strong></p></td>
       ...
       <td width="81" valign="top"><p align="right"><strong><?php $moneda=$producto['MONEDA']; echo $moneda."  ";?> <?php echo ($producto['valor_aereo_tarifa10']+$producto['valor_terrestre_tarifa10'])?></strong></p></td>                    
			    ...
			    <!--end .accordion-section-->
			    <div class="accordion-section"> <a class="accordion-section-title" href="#accordion-calen">PAYMENT CALENDAR</a>
      ...
      <thead>
        <tr>
          <th bgcolor="#CCCCCC">PAYMENT NO</th>
          <th bgcolor="#CCCCCC">DUE TO</th>
          <th bgcolor="#CCCCCC">AIR FARE</th>
          <th bgcolor="#CCCCCC">GROUND SERVICES</th>
      ...
      <?php } ?>
            ...
            <?php } ?>
                <div class="accordion-section"> <a class="accordion-section-title" href="#accordion-3">FLIGHTS SCHEDULE	</a>
			  ...
			  <div class="accordion">
			    <div class="accordion-section"> <a class="accordion-section-title" href="#accordion-docu">TRAVEL DOCUMENTATION</a>
	  ...
	  <div class="clearfix"></div>
        <div id="about">
		  <h3 id="pagos">PAYMENT METHODS</h3>
          <p>Air Ticket: the air ticket to be issued in Colombia, must be paid in Colombian pesos; in international programs, in which the value of the ticket is priced in dollars, it must be settled at the value of the Market Representative Rate (TRM) in force on the day of payment.



Terrestrial Portion: the value of terrestrial services charged in dollars, can be paid in Colombian pesos settled at the Market Representative Rate (TRM) in force on the day of payment or in dollars.
          <p>&nbsp;</p>
          <div class="accordion">
...
" class="myButton" target="_blank">Pago PSE</a></p>
          ...
          <p align="center"> </strong></p>
            ...
            <div class="accordion-section"> <a class="accordion-section-title" href="#accordion-transd">USD MONEY WIRE</a>

              <div id="accordion-transd" class="accordion-section-content">
            <p>  You can make a transfer in dollars to our account in Miami. The information of the account is the following::</p>
            <p>&nbsp;</p>
          ...
          <p>&nbsp;</p>
           <div class="clearfix"></div>
           <h3>Terms and conditions of the program</h3>
          <p>&nbsp;</p>
        
          <div class="accordion">
            
            <div class="accordion-section"> <a class="accordion-section-title" href="#accordion-t1">TErMS AND CONDITIONS</a>
    ...
    <?php if(strpos($producto['parametros'],'sinasistencia') === false){?>
          ...
          <div id="featured">
            <h4>AGREEMENT REVEALS STABLISHED BY EVENTOUR SPORT S.A.S.  (Decreto 053 de 2002)
|<br>
EVENTOUR SPORT INVOKE THIS LEGISLATION:</h4>
          <p>&nbsp; </p>
          <p>Ley 17 de 1981 Approving the convention over international commerce of endagered fauna and flora species. <br>
            Ley 397 de 1997 Dictating the standards over cultural patrimony, incentives for culture. 
Ley 679 de 2001 Fighting abbuse, pornography and sexual tourism with children and teenagers.<br>
Ley 1336 de 2009 supporting ley 679 de 2001. 
.<br>
<strong><br>
EVENTOUR SPORT S.A.S</strong>,with National Tourism Registration No.16310, invoke totally the Responsibility clause stablished in the 4th article in  Decreto 2438 de 2010 and its subsequents reforms: “assumes the reponsibility for the entire provision and quality  of the  described services in the program, with limitation in responsibility in facts of force majeure, that could happen during the journey.  By virtue of this, it reserves the right to do changes in the flights, travel dates and other services providers of equal o greater class. The traveler Will have the right to the complete reimbursement of the non used services by force majeure, according to the agreement reveals of the providers. The traveler will accomplish the legal standards,  including health standards, and will be responsible of the objects he brings.”</p>
<p>&nbsp;</p>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="background:#FFF">
  <tr>
    ...
    <?php if($producto['unidad_negocio'] == "GRUPOS ESPECIALES"){ ?>
    <strong>Maria Alejandra Moreno Quintero</strong><br>
      Jefe UN Especiales<br>
    </p> <?php }else if($producto['unidad_negocio'] == "RECEPTIVOS"){ ?>
    <strong>Jose Arley Millan</strong><br>
      Jefe UN Receptivos<br>
    </p> <?php }else{ ?>
   <strong>Maria Alejandra Moreno Quintero</strong><br>
      Jefe UN Especiales<br>
    </p>
