								...
								echo "value='".$prospecto['nombre_grupo']."'";}?>></td>
           				      ...
           				      <tr>
           				        ...
           				        <td><p>
									 ...
									 <option value="<?php if($m){echo $datos_producto['origen'];}else if($prospecto != null){echo $prospecto['origen']; }?>" selected="selected"><?php if($m){echo $datos_producto['origen'];}else if($prospecto != null){echo $prospecto['origen']; }?></option>
									</select>
           				        ...
           				        <td><p>
									 ...
									 <option value="<?php if($m){echo $datos_producto['destino'];}else if($prospecto != null){echo $prospecto['destino']; }?>" selected="selected"><?php if($m){echo $datos_producto['destino'];}else if($prospecto != null){echo $prospecto['destino']; }?></option>
									</select>
           				        </p></td>
       				          </tr>
           				      <tr>
							...
							while ($fi = mysql_fetch_array($res, MYSQL_ASSOC)) {?>
                                  ...
                                  <select name="unidadnegocio" id="unidadnegocio">
                                    ...
                                    <option value="EVENTOS ESPECIALES" <?php if("EVENTOS ESPECIALES" == $datos_producto['unidad_negocio']){ echo "selected";}?>>EVENTOS ESPECIALES</option>
									  ...
									  <option value="INDIVIDUALES" <?php if("INDIVIDUALES" == $datos_producto['unidad_negocio']){ echo "selected";}?>>INDIVIDUALES</option>
                                  </select>
           				        </p>
       				           </td>
       				          </tr>
                ...
                CKEDITOR.replace( 'terminos' );
                               ...
                               <tr>
                                  ...
                                  >
                                    ...
                                    <input type="checkbox" name="checkbox6" id="checkbox6" onClick="evalparametros('qrbancolombia')" 
                                      <?php 
								   if(strpos($param,'qrbancolombia')!== false){									  echo "checked"; 		  }?>
                                  >
   				                    QR BANCOLOMBIA			                  </p>
       				                <p>
									  ...
									  <p>
           				            <input type="checkbox" name="checkbox3" id="checkbox3" onClick="evalparametros('aviatur-bcolombia')" 
                                    <?php 
								   if(strpos($param,'aviatur-bcolombia')!== false){									  echo "checked"; 		  }?>>
           				            AVIATUR – CTA CTE BANCOLOMBIA          				            </p>


									<p>
           				            <input type="checkbox" name="checkbox3" id="checkbox3" onClick="evalparametros('aviatur-panama')" 
                                    <?php 
								   if(strpos($param,'aviatur-panama')!== false){									  echo "checked"; 		  }?>>
           				           AVIATUR – BANCOLOMBIA PANAMA  				            </p>

								   <p>
           				            <input type="checkbox" name="checkbox3" id="checkbox3" onClick="evalparametros('aviatur-itau')" 
                                    <?php 
								   if(strpos($param,'aviatur-itau')!== false){									  echo "checked"; 		  }?>>
           				            AVIATUR – BANCO ITAU EFECTIVO EN USD         				            </p>


									<p>
           				            <input type="checkbox" name="checkbox3" id="checkbox3" onClick="evalparametros('aviatur-link')" 
                                    <?php 
								   if(strpos($param,'aviatur-link')!== false){									  echo "checked"; 		  }?>>
           				            AVIATUR – link de pago         				            </p>
