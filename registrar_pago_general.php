...
{
	if(isset($_REQUEST['trm_reg'])){
		return $_REQUEST['trm_reg'];
	}
...
if(isset($_REQUEST['idviajero'])){
	...
	$control->actualizarDatosParam($_REQUEST['idviajero'],'expediente',$_REQUEST['expediente']);
...
<script>
	...
	str=document.getElementById("idviajero").value;
        ...
        xmlhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                document.getElementById("expediente").value = this.responseText.trim();
	    ...
	    xmlhttp.open("GET","api.php?expediente="+str,true);
        xmlhttp.send();
}
function saldo() {
	str=document.getElementById("idviajero").value;
        ...
        xmlhttp.send();
                                ...
                                <input type="date" name="date" id="date" value="<?php echo date("Y-m-j");?>" onChange="valortrm()"></td>
           				      ...
           				      <tr>
           				        ...
           				        <td>Abono PT</td>
           				        <td><p>
           				          <input type="number" name="pt" id="pt" placeholder="valor" step="any" value="<?php echo round($_REQUEST['val_pt'],0); ?>" >
         				          </p>
           				          <p>
           				      ...
           				      <tr>
           				        ...
           				        <td><input type="text" name="trm" id="trm" value="<?php echo $control->trmDIA(date("Y-m-d"));?>"></td>
           				        <td>Fee</td>
           				        <td><p>
           				      ...
           				      <tr>
                                  ...
                                  <option value="TC DINERS">TC DINERS</option>
           				          ...
           				          <option value="BANCOLOMBIA CTA AHORROS">BANCOLOMBIA CTA AHORROS</option>
									  <option value="BANCOLOMBIA CODIGO QR">BANCOLOMBIA CODIGO QR</option>
                                  ...
                                  <option value="CONSIGNACION DOLARES CORPBANCA">CONSIGNACION DOLARES CORPBANCA</option>
								   ...
								   <option value="DAVIVIENDA CTA CORRIENTE">DAVIVIENDA CTA CORRIENTE</option>
									 <option value="DEVOLUCION BONO LATAM">DEVOLUCION BONO LATAM</option>
                                   <option value="DEVOLUCION BONO INTERJET">DEVOLUCION BONO INTERJET</option>
									 ...
									 <option value="TC EN AEROLINEA (COPA)">TC EN AEROLINEA (COPA)</option>
                                      <option value="TC EN AEROLINEA (INTERJET)">TC EN AEROLINEA (INTERJET)</option>
									<option value="AVIATUR – CTA CTE BANCOLOMBIA">AVIATUR – CTA CTE BANCOLOMBIA</option>
									<option value="AVIATUR – BANCOLOMBIA PANAMA">AVIATUR – BANCOLOMBIA PANAMA</option>
									<option value="AVIATUR – BANCO ITAU EFECTIVO EN USD">AVIATUR – BANCO ITAU EFECTIVO EN USD</option>
									<option value="AVIATUR – link de pago">AVIATUR – link de pago</option>
                                     
                                </select></td>

								  <td>Expediente</td>
           				        <td><p>
           				          <input type="text" name="expediente" id="expediente" placeholder="expediente">
