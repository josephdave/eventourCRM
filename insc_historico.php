...
?>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">	
					...
					<div class="panel-heading">Viajeros <?php echo $control->nomGrupo($_REQUEST['grupo']); ?></div>
					<div class="panel-body">
           				  <div class="module-body"><p>&nbsp;</p>
           				  <table data-toggle="table" data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="Grupo" data-sort-order="desc" class="table table-hover">
           			 	    <thead>
           				      <th>&nbsp;</th>
           				      <th>Estado</th>
           				      ...
           				      <th data-hide="all"><strong>F Nacimiento</strong></th>
           				      <th><p><strong>Edad</strong></p></th>
           				      <th><strong>email</strong></th>
           				      <th data-hide="all"><strong>Telefono</strong></th>
           				      <th><strong>celular</strong></th>
           				      <th  data-ignore="true" data-hide="all"><strong>ciudad</strong></th>
           				      <th data-ignore="true" data-hide="all"><strong>direccion</strong></th>
           				      <th><strong>pasaporte</strong></th>
           				      <th data-ignore="true" data-hide="all"><strong>vigencia</strong></th>
           				      <th data-ignore="true" data-hide="all"><strong>visa</strong></th>
           				      <th data-ignore="true" data-hide="all"><strong>vigencia</strong></th>
           				     <?php if($_REQUEST['grupo'] != 8){?> <th><strong>Acudiente 1</strong></th>
           				      <th data-hide="all"><strong>Telefono Acudiente 1</strong></th>
           				      <th data-hide="all"><strong>Email Acudiente 1</strong></th>
           				      <th><strong>Acudiente 2</strong></th>
           				      <th data-hide="all"><strong>Telefono Acudiente 2</strong></th>
           				      <th data-hide="all"><strong>Email Acudiente 2</strong></th><?php }else{ ?>
                               <th><strong>Viaja Con</strong></th>
                              <?php } ?>
           				      <th data-hide="all"><strong>Facturacion</strong></th>
           				      <th data-hide="all"><strong>Documento</strong></th>
           				      <th data-hide="all"><strong>Direccion</strong></th>
           				      <th><strong>Documentos</strong></th>
       				        </thead>
           				    <tr>
							...
							$resultado=$control->inscritosHistorial($_REQUEST['grupo']);
                            ...
                            <td>
                              ...
                              <p><a href="insc.php?grupo=<?php echo $_REQUEST['grupo']?>&borrar=<?php echo $fi['no_documento'];?>" onclick="return confirm('Desea Borrar el registro?')">BORRAR</a></p>                              <?php } ?></td>
