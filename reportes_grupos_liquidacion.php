					      ...
					      <tr>
					        ...
					        <td>
                                ...
                                <button type="button" class="btn-xs btn-primary" onClick="location.href='proveedores_programa.php?grupo=<?php echo $fi['id'];?>'">PROVEEDORES</button>
								 ...
								 <button type="button" class="btn-xs btn-primary" onClick="location.href='liquidacion_viajero_v5.php?grupo=<?php echo $fi['id'];?>'">LIQUIDACIÓN  VIAJERO CON TIK</button>
								
								<button type="button" class="btn-xs btn-primary" onClick="location.href='liquidacion_viajero_facturacion.php?grupo=<?php echo $fi['id'];?>'">LIQUIDACIÓN PORCION TERRESTRE</button>
