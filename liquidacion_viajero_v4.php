  ...
  text-align: left;
	...
	white-space: nowrap;height: 500px;" class="table-area">
					  <table  border="1" bordercolor="#000000" cellpadding="10" cellspacing="5" id="list" width="100%" class="table-responsive tabla">
					    <thead>
					      <tr >
					        <th bgcolor="#FFCD83" data-sortable="true"><strong>Nombres</strong><br>
				            &nbsp;</th>
					        <?php 
                           ...
                           <?php 
							...
							//echo  $first_part;
                              ...
                              <?php
									...
									if($tercero != $t){
									echo " <th bgcolor='#FFCD83'><p >".$t."</p></th>";
										$tercero = $t;
										$d="";
									}
							}
						    ...
						    <th>&nbsp;</th>
							  <th bgcolor="#7BB558">Costo Total<br></th>
                           
                           <!-- <th>Pagos Viajero PT</th>-->
                            <th bgcolor="#7BB558">Valor Programa TK</th>
                            <th bgcolor="#7BB558">Valor Programa PT</th>
                            <th bgcolor="#7BB558">TOTA PROGRAMA</th>
                            <th bgcolor="#7BB558">Utilidad</th>
                            <th bgcolor="#7BB558">Margen</th>
				...
				$totales[$n]++;
						...
						<?php if(!isset($_REQUEST['pag'])){?> 
						 <a href="liquidacion_viajero_v3.php?grupo=<?php echo $prospecto['id'];?>&pag=2">Siguiente></a>
						<?php }else{ ?>
						 <a href="liquidacion_viajero_v3.php?grupo=<?php echo $prospecto['id'];?>&pag=<?php ($_REQUEST['pag']+1); ?>">Siguiente></a>
						<?php } ?>
                      </div>
                      <h2>&nbsp;</h2>
                      <p>
