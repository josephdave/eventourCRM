...
<?php 
	...
	$control->validarPagoProveedores($validados,$_REQUEST);
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">	
					...
					<div class="panel-body">
           				  <div class="module-body">
           				    <p>Se han validado los pagos a proveedores</p>
           				    <button type="button" class="btn-xs btn-primary" onClick="location.href='pagos_proveedores_validar.php'">VOLVER</button>
           				    <p>&nbsp;</p>
