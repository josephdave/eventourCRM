...
var table_html = table_html.replaceAll(',', ',');	
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">	
				...
				<div class="panel panel-default">
                                ...
                                <div id="table_wrapper">
           				      ...
           				      <tr>
           				        ...
           				        <td width="12%" bgcolor="#bbd5ff"><strong><?php 
									if(isset($_REQUEST['id_costeo'])){ echo "Viajeros con Pago:";}else{ echo "Viajeros Estimados:";}
									?></strong></td>
           				        <td width="22%"><?php 
								...
								$viajeros=$prospecto['cantidad_viajeros'];
									...
									if(isset($_REQUEST['id_costeo'])){
										$viajeros=$control->viajeroConPago($_REQUEST['id_costeo']);
									}
	 ...
	 $noches=$dias-1;
                                ...
                                <?php echo $dias; ?> dias - <?php echo $dias-1; ?> noches</td>
           				        <td bgcolor="#bbd5ff">Viajeros Prospecto</td>
           				        <td><?php $viajerosProspecto=$prospecto['cant_viajeros'];
									echo $viajerosProspecto;
									?></td>
         				        </tr>
           				      <tr>
	...
	if(mysql_num_rows($resultado)>0){
                                ...
                                <tr>
                               <td class="categoria"><strong><?php echo $cat ?></strong></td>
                               <td class="categoria">&nbsp;</td>
                                 <?php if(!isset($_REQUEST['id_prospecto'])){?><td align="right" class="categoria">&nbsp;</td><?php } ?>
                               <td align="right" class="categoria">&nbsp;</td>
                               <td align="right" class="categoria">&nbsp;</td>
                               <td >&nbsp;</td>
                             </tr>
							...
							while ($fi = mysql_fetch_array($resultado, MYSQL_ASSOC)) {
                             ...
                             <?php 
								/*
								if ( strtoupper($fi['nombre']) == "TIQUETE") {
	...
	//							 var_dump($control->impuestosRecord($contratoAerolinea['id_sillas']));
							...
							<?php }else{?>
							  ...
							  $grupo= $unitatio*$$viajerosProspecto;
							  }
							  if($fi['tipo_costo'] == 'POR DIA'){
							  $unitatio= $fi['costo_prospecto']*$dias;
							  $grupo= $fi['costo_prospecto']*$dias*$viajerosProspecto;
							  }
							 	
							   if($fi['tipo_costo'] == 'POR NOCHE'){
							  $unitatio= $fi['costo_prospecto']*($dias-1);
							  $grupo= $fi['costo_prospecto']*($dias-1)*$viajerosProspecto;
							  }
							  if($fi['tipo_costo'] == 'GRUPAL'){
							  $unitatio= $fi['costo_prospecto']/$viajerosProspecto;
							  ...
							  $grupo= $fi['costo_prospecto'];
										...
										if ( $cat != "TIQUETES"){
								$total_unit_pt_p=$total_unit_pt_p + $unitatio;
		  }	else {
									$total_unit_tk_p=$total_unit_tk_p+$unitatio;
							  ...
							  $total_grupo_p=$total_grupo_p+$grupo;
							 // $total_grupo_cat=$total_grupo_cat+$grupo;
							  
								$total_unit_p=$total_unit_p+$unitatio;
							
	
							 $total_unit_cat_p=$total_unit_cat_p+$unitatio;
							  ?></td><?php } ?>
                               <td align="right"><?php 
							  if($fi['tipo_costo'] == 'DIRECTO'){
							  ...
							  if ( $cat != "TIQUETES"){
								...
								$total_unit_pt=$total_unit_pt + $unitatio;
									...
									$total_unit_tk=$total_unit_tk+$unitatio;
									if($fi['nombre']=="TA"||$fi['nombre']=="TASA ADMINISTRATIVA"){
									$ta+=$unitatio;
									}
	...
	if(mysql_num_rows($resultado)>0){
                               ...
                               <td class="totales">&nbsp;</td>
                                 <?php if(!isset($_REQUEST['id_prospecto'])){?><td align="right" class="numeros"><strong><?php echo number_format($total_unit_cat_p,2,",",".")?></strong></td><?php } ?>
                               <td align="right" class="numeros"><strong><?php echo number_format($total_unit_cat,2,",",".")?></strong></td>
                               <td align="right" class="numeros"><strong><?php echo number_format($total_grupo_cat,2,",",".") ?></strong></td>
                               <td >&nbsp;</td>
                             </tr>
                          ...
                          <?php if(!isset($_REQUEST['id_prospecto'])){?>   <td align="right" class="directos"><strong><?php echo number_format($total_unit_pt_p,2,",",".");?></strong></td><?php }?>
	 ...
	 $resultado=$control->costeoListaProdPROSPECTO($_REQUEST['id_prospecto'],'COMISIONES',$multi);
							...
							<?php }else{?>
							 ...
							 $total_unit_cat_p=$total_unit_cat_p+$unitatio;
							 $comision_grupo_p=$comision_grupo_p+$grupo;
							  $comision_unit_p=$comision_unit_p+$unitatio;
							  ?></td><?php }?>
                              <td align="right"><?php 
	...
	?>
                              ...
                              <?php } ?>
                               ...
                               <td class="totales">&nbsp;</td>
                                 <?php if(!isset($_REQUEST['id_prospecto'])){?><td align="right" class="numeros"><strong><?php echo number_format($comision_unit_p,2,",",".")?></strong></td><?php }?>
                               ...
                               <td>&nbsp;</td>
                                ...
                                <tr>
                                  ...
                                  <?php if(!isset($_REQUEST['id_prospecto'])){?>  <td align="right" class="directos"><strong>
                                    <?php $subtotal_p=$comision_unit_p+$total_unit_pt_p;
								  echo number_format($subtotal_p,2,",","."); ?>
                                  </strong></td><?php }?>
                                ...
                                <tr id="detalle_costos" >
                                  ...
                                  PT 31%</td>
                                 <?php if(!isset($_REQUEST['id_prospecto'])){?>   <td align="right"><strong>
                                   <?php $subtotal_p=$comision_unit_p+$total_unit_pt_p;
								  echo number_format($subtotal_p*0.31,2,",","."); ?>
                                 </strong></td><?php }?>
                                ...
                                <tr id="detalle_costos2" >
                                  ...
                                  <?php if(!isset($_REQUEST['id_prospecto'])){?>  <td align="right"><strong><?php echo number_format($subtotal_p+($subtotal_p*0.31),2,",",".")?></strong></td><?php }?>
                                ...
                                <tr>
                                  ...
                                  <?php if(!isset($_REQUEST['id_prospecto'])){?>
									<td align="right" class="directos"><strong>
									  <?php $subtotal_p=$total_unit_tk_p-$ta_p;
									//  var_dump($total_unit_tk);
								  echo number_format($subtotal,2,",","."); ?>
									</strong></td>
									<?php }?>
                                ...
                                <tr>
                                  <td>&nbsp;</td>
                                  <td>&nbsp;</td>
                                   <?php if(!isset($_REQUEST['id_prospecto'])){?> <td align="right">&nbsp;</td><?php }?>
                                  <td align="right">&nbsp;</td>
                                  <td align="right">&nbsp;</td>
                                  <td>&nbsp;</td>
                                </tr>
                                <tr>
                                  ...
                                  <td class="resultados">PRECIO VENTA REAL PT</td>
                                    <?php if(!isset($_REQUEST['id_prospecto'])){?><td align="right" class="resultados"><?php 
								  if($multi == 1){
								  $precioFinal=($prospecto['valor_terrestre']);
								  }else{
								  $precioFinal=($prospecto['valor_terrestre_tarifa'.$multi]);
								  }
								  echo number_format($precioFinal,2,",",".") ?></td><?php }?>
								 ...
								 // echo number_format((($precioFinal-$total_unit_pt)/($total_unit_pt+$comision_unit))*100,0,".",","); 
								  ...
								  ?>% </td>
                                    <?php if(!isset($_REQUEST['id_prospecto'])){?><td align="right"><?php  echo number_format($precioFinal-$total_unit_pt_p-$comision_unit_p,2,",",".");?></td><?php }?>
						        ...
						        <tr id="detalle_margentk" style="display: none">
								  ...
								  ?>
						            % </td>
						          <?php if(!isset($_REQUEST['id_prospecto'])){?>
						          <td align="right"><?php  echo number_format($precioFinaltk-($total_unit_tk_p-$ta_p),2,",",".");?></td>
						          <?php }?>
                                ...
                                <tr>
								 ...
								 // echo number_format((($precioFinaltotal-(($total_unit_tk-$ta)+$total_unit_pt))/(($total_unit_tk-$ta)+$total_unit_pt+$comision_unit))*100,0,".",","); 
									  ...
									  echo number_format((($precioFinaltotal-(($total_unit_tk-$ta)+$total_unit_pt+$comision_unit))/$precioFinaltotal)*100,2);
								  ?>
                                    % </td>
                                  <?php if(!isset($_REQUEST['id_prospecto'])){?>
                                  <td align="right" class="contribucion">(
                                    <?php
								 // echo number_format((($precioFinaltotal-(($total_unit_tk-$ta)+$total_unit_pt))/(($total_unit_tk-$ta)+$total_unit_pt+$comision_unit))*100,0,".",","); 
									  
									  echo number_format((($precioFinaltotal-(($total_unit_tk_p-$ta_p)+$total_unit_pt_p+$comision_unit_p))/$precioFinaltotal)*100,2);
								  ?>
%) <?php  echo number_format($precioFinaltotal-(($total_unit_tk_p-$ta_p)+$total_unit_pt_p+$comision_unit_p),2,",",".");?></td>
                                  <?php }?>
	...
	$resultado=$control->gruposProspecto();
				...
				//var_dump($fi);
							...
							?>
							  ...
							  echo strtoupper( date('Y', strtotime( $fi['fecha_salida']))." ".$fi['grupo']."".$fi['nombre_grupo'])."-".strtoupper( $fi['nombre_tarifa'.$i]);?>
   				                      </option>
       				                  <?php
									}
								}
