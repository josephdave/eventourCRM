...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
  <?php for($i=date("Y")+1;$i>=2017;$i--){ ?>
    ...
    <div class="panel-heading">GRUPOS JUVENILES <?php echo $i?></div>
      ...
      <div class="module-body">
        ...
        <div id="table_wrapper3">
		  ...
		  $total_insc_viaja=0;
							...
							$resultado=$control->gruposAnio($i);
     ...
     $dias= floor($datediff/(60*60*24))+1;
            ...
            <tfoot>
              <tr>
                ...
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td style="text-align: left"><?php echo $total_insc2;?></td>
                <td style="text-align: left"><?php echo $total_insc;?></td>
                <td style="text-align: left"><?php echo $total_conpago;?></td>
                <td style="text-align: left"><?php echo $total_conpago_no;?></td>
                <td style="text-align: left"><?php echo $total_insc_viaja;?></td>
