					...
					<div class="panel-body">
           				  <div class="module-body"><p>&nbsp;</p>
           				    <form id="form2" name="form2" method="post">
								<input type="text" id="buscar" name="buscar" placeholder="BUSCAR" value="<?php echo $_REQUEST['buscar']?>">
							...
							$resultado=$control->inscritosbuscar($_REQUEST['grupo'],$_REQUEST['buscar']);
