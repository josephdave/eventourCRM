...
<body>
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		...
		<?php 
	if($_SESSION['id'] != ""){
	if( strpos(strtolower($_SESSION['password']),"eventour") === false){?>
...
<!--		<form role="search">
		...
		<ul class="nav menu">
            ...
            <li class="parent ">
			  <a href="#">
					<span data-toggle="collapse" href="#sub-item-0" class="collapsed"><svg class="glyph stroked gear"><use xlink:href="#stroked-gear"/></svg> Proveedores</a> </a>
               ...
               <li class="active"> <a class="" href="proveedores.php"> <svg class="glyph stroked table">
					...
					<li>
                     ...
                     Resumen Proveedores</a></li>
						  <li class="active"> <a class="" href="pagos_registrados_proveedores.php"> <svg class="glyph stroked table">
                        <use xlink:href="#stroked-table"></use>
                      </svg>
                     Ver Pagos</a></li>
						<li>
						<a class="" href="sarlaft_proveedores.php?p=1">
							<svg class="glyph stroked table"><use xlink:href="#stroked-table"></use></svg> 
							SAGRLAFT pendientes
						</a>
					</li>
						<li>
						<a class="" href="sarlaft_proveedores.php">
							<svg class="glyph stroked table"><use xlink:href="#stroked-table"></use></svg> 
							SAGRLAFT TODOS
						</a>
					</li>
			...
			<li class="parent ">
				<a href="#">
					<span data-toggle="collapse" href="#sub-item-1" class="collapsed"><svg class="glyph stroked download"><use xlink:href="#stroked-download"/></svg> Preparación</a> </a>
			...
			<li class="parent ">
				...
				<ul class="children collapse" id="sub-item-2" >
					...
					<li>
						<a class="" href="reportes_liquidacion.php">
							<svg class="glyph stroked table"><use xlink:href="#stroked-table"></use>
							</svg>Liquidacion Programas</a></li>
					
				</ul>
			</li>
			                         <li class="parent ">
				<a href="#">
					<span data-toggle="collapse" href="#sub-item-3" class="collapsed"><svg class="glyph stroked male user "><use xlink:href="#stroked-male-user"/></svg>Viajeros</span></a>
				</a>
            ...
            <li class="parent ">
				<a href="#">
				<span data-toggle="collapse" href="#sub-item-4" class="collapsed"><svg class="glyph stroked line-graph"><use xlink:href="#stroked-line-graph"></use></svg>
				Pagos Recibidos</span></a>
				<ul class="children collapse" id="sub-item-4">
					...
					<li>
						<a class="" href="pagos_registrados.php?h=1">
							<svg class="glyph stroked table"><use xlink:href="#stroked-table"></use>
							</svg>Ver Registros Historico</a>
					</li>
                    	<li>
                    ...
                    <li>
						<a class="" href="informe_pagos.php">
							<svg class="glyph stroked table"><use xlink:href="#stroked-table"></use>
							</svg>Consolidado Pagos</a></li>
					   <li>
						<a class="" href="pagos_noviaja.php">
							<svg class="glyph stroked table"><use xlink:href="#stroked-table"></use>
							</svg>Pagos NO VIAJAN</a></li>
                ...
                <li class="parent ">
				<a href="#">
					<span data-toggle="collapse" href="#sub-item-5" class="collapsed"><svg class="glyph stroked clipboard with paper"><use xlink:href="#stroked-clipboard-with-paper"/></svg>Operativo</span></a>
				</a>
				<ul class="children collapse" id="sub-item-5">
					  ...
					  <li> <a class="" href="reporte_alojamiento.php"> <svg class="glyph stroked table">
                           <use xlink:href="#stroked-table"></use>
                         </svg>Reportes Alojamiento</a></li>
					 <li> <a class="" href="reportes_grupos_liquidacion.php"> <svg class="glyph stroked table">
                           <use xlink:href="#stroked-table"></use>
                         </svg>Reportes Liquidacion</a></li>
...
<li class="parent ">
				<a href="#">
				<span data-toggle="collapse" href="#sub-item-9" class="collapsed"><svg class="glyph stroked chevron-down"><use xlink:href="#stroked-chevron-down"></use>
					</svg>
				Aerolineas</span></a>
				</a>
                ...
                <li class="parent ">
				<a href="#">
					<span data-toggle="collapse" href="#sub-item-6" class="collapsed"><svg class="glyph stroked calendar"><use xlink:href="#stroked-calendar"/></svg>Reportes</span></a>
				</a>
				<ul class="children collapse" id="sub-item-6">
                    ...
                    <li>
						...
						Calendario Viajes</a></li>
                    <li><a class="" href="roominglist3.php"><svg class="glyph stroked table"><use xlink:href="#stroked-table"></use>
						</svg>Control Hoteles</a>
                    </li>
					<li><a class="" href="status_costos.php"><svg class="glyph stroked table"><use xlink:href="#stroked-table"></use>
						</svg>Reporte Margen</a>
                    </li>
					<li><a class="" href="reporte_google.php"><svg class="glyph stroked table"><use xlink:href="#stroked-table"></use>
						</svg>Reporte Recaudos (GRAFICO)</a>
                    </li>
					<li><a class="" href="reporte_google.php?g=1"><svg class="glyph stroked table"><use xlink:href="#stroked-table"></use>
						</svg>Reporte Servicios (GRAFICO)</a>
                    </li>
