					...
					$grupo=explode(";",$fis['viajeros']);
							...
							if($c==0){
							 echo $datviajero2['nombres']." ".$datviajero2['apellidos']." "; $c++;
								...
								?>
								  <td style="border-top: solid 2px #000000; border-left: solid 1px;
   								 border-right: solid 1px; border-bottom: dashed 1px #000000;border-bottom: dashed 1px #000000;"><?php echo $datviajero['observaciones'];?></td>
				...
				$datviajero=$control->datosViajeroID($grupo[$i]);
							 ...
							 echo $datviajero['nombres']." ".$datviajero['apellidos']."";
							  echo "</td>";
   								 ...
   								 border-right: solid 1px; border-bottom: dashed 1px #000000;"><?php echo $datviajero['observaciones'];?></td>
