...
if(isset($_REQUEST["borrar_tiquete"]) ){
	
	$resultado=$control->borrarTiquete($_REQUEST['borrar_tiquete']);
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            ...
            <a href="upload.php?grupo=<?php echo $prospecto['id'] ?>">
                                <?php if(file_exists("imagenes/productos/logo_".$prospecto['id'].".jpg")){?><img  style="margin: 0 auto;"  class="profile-user-img img-responsive" src="http://eventoursport.travel/crm/imagenes/productos/logo_<?php echo $prospecto['id'] ?>.jpg"  alt="" width="150"/><?php } else{?>
                                <img src="imagenes/productos/nologo.jpg" width="150" height="150"  style="margin: 0 auto;" class="profile-user-img img-responsive" alt=""/>
                                <?php } ?></a>
              <h3 class="profile-username text-center"><?php echo $prospecto['grupo']; ?></h3>

              <p class="text-muted text-center"><?php echo $prospecto['origen'] ?> - <?php echo $prospecto['destino'] ?></p>

              <ul class="list-group list-group-unbordered">
                <li class="list-group-item">
                  <b>Viajeros</b> <a class="pull-right"><?php echo $prospecto['cant_viajeros']; ?></a>
                </li>
                <li class="list-group-item">
                  <b>Fechas</b> <a class="pull-right"><?php echo date_format(date_create($prospecto['f_salida']),"d-m-Y"); ?> - <?php echo date_format(date_create($prospecto['f_llegada']),"d-m-Y"); ?></a>
                </li>
                <li class="list-group-item">
                  <b>Encargado:</b> <a class="pull-right"><?php  $usuario=$control->datosUsuario($prospecto['encargado']);
							  echo strtoupper($usuario['nombre']);?></a>
                </li>
              </ul>

              <a href="registrar_producto.php?modificar=<?php echo $id_grupo;?>" class="btn btn-primary btn-block"><b>MODIFICAR</b></a>
              <a href="producto.php?archivar=<?php echo $prospecto['id'] ?>&estado_final=<?php echo $prospecto['estado']; ?>&grupo=<?php echo $prospecto['id'] ?>" class="btn btn-block btn-danger"><b>ARCHIVAR PROGRAMA</b></a>
				<p>&nbsp;</p>
				<p class="text-muted text-center" ><a href="grupos.php?borrar=<?php echo $id_grupo;?>" onclick="return confirm('Desea Borrar?')">ELIMINAR</a></p>
            </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
 <h3 class="profile-username text-center">SUBPROGRAMAS</h3>
				 <ul class="list-group list-group-unbordered">
              
					 <li class="list-group-item"><a href="costeo_multitarifa.php?id_costeo=<?php echo $id_grupo ?>&multitarifa=1"><?php echo $prospecto['nombre_tarifa1'];?></a><br>
					<span>$<?php echo $prospecto['valor_aereo']+$prospecto['valor_terrestre'];?></span>
                 <span class="pull-right"> <?php echo $control->viajerosTarifa($prospecto['nombre_tarifa1'],$prospecto['id']) ?></span>
					 </li>
					 
					   <?php if($prospecto['nombre_tarifa2'] != ""){ ?>
					 <li class="list-group-item"><a href="costeo_multitarifa.php?id_costeo=<?php echo $id_grupo ?>&multitarifa=2"><?php echo $prospecto['nombre_tarifa2'];?></a><br>
					<span>$<?php echo $prospecto['valor_aereo2']+$prospecto['valor_terrestre2'];?></span>
                 <span class="pull-right"> <?php echo $control->viajerosTarifa($prospecto['nombre_tarifa2'],$prospecto['id']) ?></span>
                </li><?php }?>
					 		   <?php if($prospecto['nombre_tarifa3'] != ""){ ?>
					 <li class="list-group-item"><a href="costeo_multitarifa.php?id_costeo=<?php echo $id_grupo ?>&multitarifa=3"><?php echo $prospecto['nombre_tarifa3'];?></a><br>
					<span>$<?php echo $prospecto['valor_aereo3']+$prospecto['valor_terrestre3'];?></span>
                 <span class="pull-right"> <?php echo $control->viajerosTarifa($prospecto['nombre_tarifa3'],$prospecto['id']) ?></span>
                </li><?php }?>
					 
					 		   <?php if($prospecto['nombre_tarifa4'] != ""){ ?>
					 <li class="list-group-item"><a href="costeo_multitarifa.php?id_costeo=<?php echo $id_grupo ?>&multitarifa=4"><?php echo $prospecto['nombre_tarifa4'];?></a><br>
					<span>$<?php echo $prospecto['valor_aereo4']+$prospecto['valor_terrestre4'];?></span>
                 <span class="pull-right"> <?php echo $control->viajerosTarifa($prospecto['nombre_tarifa4'],$prospecto['id']) ?></span>
                </li><?php }?>
					 
					 
					 		   <?php if($prospecto['nombre_tarifa5'] != ""){ ?>
					 <li class="list-group-item"><a href="costeo_multitarifa.php?id_costeo=<?php echo $id_grupo ?>&multitarifa=5"><?php echo $prospecto['nombre_tarifa5'];?></a><br>
					<span>$<?php echo $prospecto['valor_aereo5']+$prospecto['valor_terrestre5'];?></span>
                 <span class="pull-right"> <?php echo $control->viajerosTarifa($prospecto['nombre_tarifa5'],$prospecto['id']) ?></span>
                </li><?php }?>
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="profile-username text-center">LINKS</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
    ...
    <?php } ?>
              ...
              <strong><i class="fa fa-map-marker margin-r-5"></i> INSCRIPCION:</strong>

              <p class="text-muted"><a href="https://eventoursport.travel/crm/registro.php?plan=<?php echo $prospecto['id'] ?>" target="_blank">https://eventoursport.travel/crm/registro.php?plan=<?php echo $prospecto['id'] ?></a></p>

              <hr>
				
				             <strong><i class="fa fa-map-marker margin-r-5"></i> PDF PROGRAMA:</strong>

                             <p class="text-muted"><a href="https://eventoursport.travel/crm/impresion/pdf/programa_pdf.php?plan=<?php echo $prospecto['id'] ?>" target="_blank">https://eventoursport.travel/crm/impresion/pdf/programa_pdf.php?plan=<?php echo $prospecto['id'] ?></a></p>

              <hr>
				
			 

              <p><strong><i class="fa fa-pencil margin-r-5"></i></strong></p>
            </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
        ...
        <div class="col-md-9">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#activity" data-toggle="tab" aria-expanded="true">VIAJEROS</a></li>
              <li class=""><a href="#contratos" data-toggle="tab" aria-expanded="false">AEROLINEAS</a></li>
              ...
              <div class="tab-pane active" id="activity">
				  <table class="table" data-toggle="table" data-show-refresh="false" data-show-toggle="false" data-show-columns="true" data-search="true"  data-filter-control="true" data-pagination="false" data-sort-name="producto" data-sort-order="desc">
   				              ...
   				              <tr>
         				          ...
         				          <th data-sortable="true"data-field="filtroc" data-filter-control="select" data-hide="all" data-visible="false">Nombre Contrato Aerolinea<br></th>
         				          <th data-sortable="true"data-field="contrato" data-hide="all" data-visible="false"><p>Contrato Aerolinea Modificable</p></th>
         				          ...
         				          <th data-hide="all" data-visible="false">Documento</th>
         				          <th data-hide="all" data-visible="false">Permiso</th>
         				          <th data-hide="all" data-visible="false">Documento Tercero</th>
         				          <th data-hide="all" data-visible="false">Contrato</th>
                                   
         				          <th data-hide="all" data-visible="false"><strong>Otros Documentos</strong></th>
                                  <th data-hide="all" data-visible="false">Observaciones</th>
                                  <th><strong></strong></th>
         				            </thead>
                              <tr>
       				                                          <?php 
							...
							?>
								...
								if($acceso == 1){ ?>
       				                                          ...
       				                                          <td><?php echo strtoupper($fi['nombres']);?> <?php echo strtoupper($fi['apellidos']);?><br>
...
<select name="record" id="record" onchange="getElementById('form2<?php echo  $fi['no_documento'];?>').submit()">
							...
							while ($fd = mysql_fetch_array($r, MYSQL_ASSOC)) {?>
							  ...
							  if($control->edad($fi['fnacimiento'],$_REQUEST['grupo'])>=18){echo "N/A";}?></td>
       				                                          ...
       				                                          <td><p><?php if(file_exists("impresion/pdf/contratos_firmados/contrato_".$fi['no_documento'].".pdf")){?>
								 								  <a href="https://eventoursport.travel/crm/impresion/pdf/contratos_firmados/contrato_<?php echo $fi['no_documento'];?>.pdf" target="_blank"><img src='images/icon-download.png' width='20' height='20'  alt='descargar contrato' title='descargar contrato'/></a><?php
							  }else{?><a href="https://eventoursport.travel/crm/impresion/pdf/contrato_pdf.php?firma=<?php echo $fi['no_documento'];?>&carta_aceptacion=<?php echo $carta_aceptacion;?>&descarga=i" target="_blank"><img src='images/icon-download.png' width='20' height='20'  alt='descargar contrato' title='descargar contrato'/></a><?php }?><a href="https://eventoursport.travel/crm/registro.php?plan=<?php echo $id_grupo;?>&paso=2&no_docuento=<?php echo $fi['no_documento'] ?>&email=<?php echo $fi['email'] ?>" target="_blank"><img src='images/icon-firmar.png' width='20' height='20'  alt='firmar contrato'  title='firmar contrato'/></a>
 ...
 <input type="hidden" id="idviajero" name="idviajero" value="<?php echo  $fi['id'];?>">
				...
				<div class="tab-pane" id="contratos">
				  <table class="table" data-toggle="table" data-show-refresh="false" data-show-toggle="false" data-show-columns="true" data-search="true"  data-filter-control="true" data-pagination="false" data-sort-name="producto" data-sort-order="desc">
           				      <thead>
   				              <tr>
       				            <th data-hide="all" data-visible="false">Estado</th>
         				          <?php if($_REQUEST['grupo'] == 0){?>
         				          <?php } ?>
         				          <th><strong>Documento</strong></th>
         				          <th data-sortable="true"><strong>Nombres</strong></th>
         				          <th data-sortable="true"data-field="filtroc" data-filter-control="select" data-hide="all" data-visible="false">Nombre Contrato Aerolinea<br></th>
         				          <th data-sortable="true" data-field="contrato" ><p>Contrato Aerolinea </p></th>
         				          <th data-hide="all" data-visible="false"><strong>F Nacimiento</strong></th>
         				          <th><p><strong>Edad</strong></p></th>
         				          <th data-hide="all" data-visible="false"><strong>email</strong></th>
         				          <th data-hide="all" data-visible="false"><strong>Telefono</strong></th>
         				          <th data-hide="all" data-visible="false"><strong>celular</strong></th>
         				          <th  data-ignore="true" data-hide="all" data-visible="false"><strong>ciudad</strong></th>
         				          <th data-ignore="true" data-hide="all" data-visible="false"><strong>direccion</strong></th>
         				          <th data-ignore="true" data-hide="all" data-visible="false"><strong>pasaporte</strong></th>
         				          <th data-ignore="true" data-hide="all" data-visible="false"> <strong>vigencia</strong></th>
    ...
    <td colspan="2"><table data-toggle="table" data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="false" data-sort-name="producto" data-sort-order="desc" class="table table-hover">
                ...
                <tr>
			      ...
			      <td><?php echo strtoupper($fi['politica_tc']);?></td>
                            ...
                            <td><a href="producto.php?grupo=<?php echo $id_grupo ?>&borrar_tiquete=<?php echo $fi['id']?>">X</a></td>
...
echo strftime("%d-%b-%Y",strtotime($fi5['fecha']));
        ...
        <td><a href="producto.php?grupo=<?php echo $id_grupo;?>&borra_calendario=<?php echo $fi5['id'];?>" onclick="return confirm('Desea Borrar?')">X</a>  <a href="registrar_calendariopagos.php?idgrupo=<?php echo $id_grupo?>&id=<?php echo $fi5['id']?>">MODIFICAR</a></td>
      </tr>
      <?php } ?>
    </table></td>
    </tr>
