	...
	//var_dump($viajero);?>
       ...
       <?php if(isset($mensaje)){?>
           				      ...
           				      <tr>
           				        ...
           				        <td><p>
									<select class="js-data-example-ajax" style="width: 150px" name="origen" id="origen">
									 <option value="<?php echo $prospecto['origen'] ?>" selected="selected"><?php echo $prospecto['origen'] ?></option>
									</select>
           				        ...
           				        <select class="js-data-example-ajax2" style="width: 150px" name="destino" id="destino">
									 <option value="<?php echo $prospecto['destino'] ?>" selected="selected"><?php echo $prospecto['destino'] ?></option>
									</select>
           				        </p></td>
       				          </tr>
           				      <tr>
						 ...
						 if($_SESSION['id'] == $fi['user_id']){ echo "selected";}
           				      ...
           				      <tr>
           				        <td colspan="4"><input type="submit" name="Registrar" id="Registrar" value="Registrar"> <input type="button" name="button" id="button" value="Volver" onclick="location.href='gruposprospecto.php';" > 
